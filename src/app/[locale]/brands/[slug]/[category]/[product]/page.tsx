...
const MOBIL_INDUSTRIAL_PRODUCTS: Record<string, ProductSpec> = {
  ...
  "almo-oil-525": {
    ...
    api: "", acea: "",
    approvals: [],
    description: "Mobil Almo 500 Serisi yağlar, galeri içinde ve açık alandaki, madencilik işlemlerinde kayaların pnömatik olarak delinmesinde kullanılan matkapların yağlanması amacına yönelik süper kalite ve üstün performanslı ürünlerdir. Mobil Almo 500 Serisi aşınma ve korozyona karşı yüksek koruyuculuk ve mükemmel",
    features: ["Özellikleri","Etkili kimyasal kararlılık","Valf çalışmasını iyileştirir","İstenilen emülsiyon özellikleri","Yüksek viskozite indeksi","Mükemmel yük taşıma kapasitesi ve aşınmaya karşı koruma"],
    image: "/images/products/mobil/almo-oil-525.jpg",
    fullDescription: `Mobil Almo 500 Serisi yağlar, galeri içinde ve açık alandaki, madencilik işlemlerinde kayaların pnömatik olarak delinmesinde kullanılan matkapların yağlanması amacına yönelik süper kalite ve üstün performanslı ürünlerdir. Mobil Almo 500 Serisi aşınma ve korozyona karşı yüksek koruyuculuk ve mükemmel kimyasal kararlılık sağlayan yüksek kaliteli baz yağlar ve katıklarla formüle edilmiştir. Bu yağlar optimum yapışkanlık sağlarlarken, aynı zamanda suyun aşınma ve korozyon açısından oluşturduğu olums`,
  },
  "velocite-oil-no-4": {
    name: "Mobil Velocite Oil No 4", grade: "4", series: "Mobil Velocite Oil No", type: "Mil Yağı",
    api: "Cincinnati Machine P-65", acea: "Cincinnati Machine P-62",
    approvals: ["Cincinnati Machine P-45"],
    description: "Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. B",
    features: ["Yüksek oksidasyon direnci","Yağ ömrünü uzatır","Ekipman ömrünü uzatır","Etkili sudan ayrılma","Emülsiyon oluşumunu engeller","Nemi kritik yağlama alanlarından uzak tutar"],
    image: "/images/products/mobil/velocite-oil-no-4.jpg",
    fullDescription: `Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. Bu yağlar özel olarak seçilmiş yüksek kaliteli, düşük viskoziteli baz yağlar ve oksidasyon, pas ve korozyona karşı iyi direnç sağlayan katıklar ile formüle edilmiştir. Bu yağların köpük oluşumuna karşı`,
  },
  "velocite-oil-no-10": {
    name: "Mobil Velocite Oil No 10", grade: "ISO VG 10", series: "Mobil Velocite Oil No", type: "Mil Yağı",
    api: "Cincinnati Machine P-65", acea: "Cincinnati Machine P-62",
    approvals: ["Cincinnati Machine P-45"],
    description: "Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. B",
    features: ["Yüksek oksidasyon direnci","Yağ ömrünü uzatır","Ekipman ömrünü uzatır","Etkili sudan ayrılma","Emülsiyon oluşumunu engeller","Nemi kritik yağlama alanlarından uzak tutar"],
    image: "/images/products/mobil/velocite-oil-no-10.jpg",
    fullDescription: `Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. Bu yağlar özel olarak seçilmiş yüksek kaliteli, düşük viskoziteli baz yağlar ve oksidasyon, pas ve korozyona karşı iyi direnç sağlayan katıklar ile formüle edilmiştir. Bu yağların köpük oluşumuna karşı`,
  },
  "almo-oil-527": {
    name: "Mobil Almo Oil 527", grade: "ISO VG 527", series: "Mobil Almo Oil", type: "Pnömatik Ekipman Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Almo 500 Serisi yağlar, galeri içinde ve açık alandaki, madencilik işlemlerinde kayaların pnömatik olarak delinmesinde kullanılan matkapların yağlanması amacına yönelik süper kalite ve üstün performanslı ürünlerdir. Mobil Almo 500 Serisi aşınma ve korozyona karşı yüksek koruyuculuk ve mükemmel",
    features: ["Özellikleri","Etkili kimyasal kararlılık","Valf çalışmasını iyileştirir","İstenilen emülsiyon özellikleri","Yüksek viskozite indeksi","Mükemmel yük taşıma kapasitesi ve aşınmaya karşı koruma"],
    image: "/images/products/mobil/almo-oil-527.jpg",
    fullDescription: `Mobil Almo 500 Serisi yağlar, galeri içinde ve açık alandaki, madencilik işlemlerinde kayaların pnömatik olarak delinmesinde kullanılan matkapların yağlanması amacına yönelik süper kalite ve üstün performanslı ürünlerdir. Mobil Almo 500 Serisi aşınma ve korozyona karşı yüksek koruyuculuk ve mükemmel kimyasal kararlılık sağlayan yüksek kaliteli baz yağlar ve katıklarla formüle edilmiştir. Bu yağlar optimum yapışkanlık sağlarlarken, aynı zamanda suyun aşınma ve korozyon açısından oluşturduğu olums`,
  },
  "met-763": {
    name: "Mobil Met 763", grade: "ISO VG 763", series: "Mobil Met", type: "Metal İşleme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Ö",
    features: ["Mükemmel parça işleme performansı","Mükemmel yağlama özelliği","Çok amaçlı kullanım","Açık renkli ve saydam görünüm","Yağ sisini önleyen formülasyon","Çalışma yeri güvenliğini artırır"],
    image: "/images/products/mobil/met-763.jpg",
    fullDescription: `Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Önde gelen diğer üstün kalite kesme yağlarına kıyasla Mobilmet 760 Serisi, yüzey kalitesi, takım ömrünü artırma ve uç kaynama kontrolü açısından üstün performans sergilerler. Açık renkleri sayesinde iş`,
  },
  "met-766": {
    name: "Mobil Met 766", grade: "ISO VG 766", series: "Mobil Met", type: "Metal İşleme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Ö",
    features: ["Mükemmel parça işleme performansı","Mükemmel yağlama özelliği","Çok amaçlı kullanım","Açık renkli ve saydam görünüm","Yağ sisini önleyen formülasyon","Çalışma yeri güvenliğini artırır"],
    image: "/images/products/mobil/met-766.jpg",
    fullDescription: `Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Önde gelen diğer üstün kalite kesme yağlarına kıyasla Mobilmet 760 Serisi, yüzey kalitesi, takım ömrünü artırma ve uç kaynama kontrolü açısından üstün performans sergilerler. Açık renkleri sayesinde iş`,
  },
  "met-424": {
    name: "Mobil Met 424", grade: "ISO VG 424", series: "Mobil Met", type: "Metal İşleme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilmet 400 Serisi yüksek performanslı, çok amaçlı korozif olmayan ve su ile karıştırmadan kullanılan metal işleme yağlarıdır. Bu yağlar, hafif ve orta hizmet talaşlı imalat işlemleri için tasarlanmış olmakla birlikte aynı zamanda kesme yağı ve yağlama yağı arasındaki karşılıklı karışmanın neden ol",
    features: ["Mükemmel talaşlı imalat kapasitesi","Çok çeşitli malzeme ve operasyon ile uygunluk","Kızak ve tezgah fikstürleri üzerinde leke oluşturmaz","Açık renkli, saydam","Yağ sisi azdır","Daha güvenli ve konforlu bir çalışma ortamı sağlar"],
    image: "/images/products/mobil/met-424.jpg",
    fullDescription: `Mobilmet 400 Serisi yüksek performanslı, çok amaçlı korozif olmayan ve su ile karıştırmadan kullanılan metal işleme yağlarıdır. Bu yağlar, hafif ve orta hizmet talaşlı imalat işlemleri için tasarlanmış olmakla birlikte aynı zamanda kesme yağı ve yağlama yağı arasındaki karşılıklı karışmanın neden olabileceği problemleri önlediğinden takım tezgahları yağları ve hidrolik yağı olarak kullanılabilmektedir. Bu yağlar yüksek kaliteli baz yağlar ve çok geniş bir uygulama alanında etkili bir talaşlı ima`,
  },
  "dte-27": {
    name: "Mobil DTE 27", grade: "ISO VG 27", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-27.jpg",
    fullDescription: `Çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında yüksek basınç`,
  },
  "dte-24": {
    name: "Mobil DTE 24", grade: "ISO VG 24", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Mobil Dte 24 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-24.jpg",
    fullDescription: `Mobil Dte 24 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında`,
  },
  "dte-26": {
    name: "Mobil DTE 26", grade: "ISO VG 26", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Mobil Dte 26 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-26.jpg",
    fullDescription: `Mobil Dte 26 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında`,
  },
  "dte-25": {
    name: "Mobil DTE 25", grade: "ISO VG 25", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Mobil Dte 25 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-25.jpg",
    fullDescription: `Mobil Dte 25 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında`,
  },
  "vactra-oil-no-1": {
    name: "Mobil Vactra Oil No 1", grade: "1", series: "Mobil Vactra Oil No", type: "Kızak ve Yol Kılavuzu Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ",
    features: ["Kontrollü Sürtünme Özellikleri","Çoklu Malzeme Becerileri","Su ve su bazlı soğutucu sıvısından kolay ayrışabilme","Yapışkanlık","Uzun Vadeli Pas ve Korozyona karşı Koruma","Uygulamalar"],
    image: "/images/products/mobil/vactra-oil-no-1.jpg",
    fullDescription: `Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ve kontrollü sürtünme özellikleri sağlayan, su ile karışan metal işleme sıvılarıyla uyumlu ve parçalarda ve ekipmanda korozyona karşı koruma sağlayan gelişmiş bir katkı sistemi ile performans dengesi`,
  },
  "vactra-oil-no-4": {
    name: "Mobil Vactra Oil No 4", grade: "4", series: "Mobil Vactra Oil No", type: "Kızak ve Yol Kılavuzu Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ",
    features: ["Kontrollü Sürtünme Özellikleri","Çoklu Malzeme Becerileri","Su ve su bazlı soğutucu sıvısından kolay ayrışabilme","Yapışkanlık","Uzun Vadeli Pas ve Korozyona karşı Koruma","Uygulamalar"],
    image: "/images/products/mobil/vactra-oil-no-4.jpg",
    fullDescription: `Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ve kontrollü sürtünme özellikleri sağlayan, su ile karışan metal işleme sıvılarıyla uyumlu ve parçalarda ve ekipmanda korozyona karşı koruma sağlayan gelişmiş bir katkı sistemi ile performans dengesi`,
  },
  "vactra-oil-no-2": {
    name: "Mobil Vactra Oil No 2", grade: "2", series: "Mobil Vactra Oil No", type: "Kızak ve Yol Kılavuzu Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ",
    features: ["Kontrollü Sürtünme Özellikleri","Çoklu Malzeme Becerileri","Su ve su bazlı soğutucu sıvısından kolay ayrışabilme","Yapışkanlık","Uzun Vadeli Pas ve Korozyona karşı Koruma","Uygulamalar"],
    image: "/images/products/mobil/vactra-oil-no-2.jpg",
    fullDescription: `Mobil Vactra ™ Oil Numbered Serisi, hassas tezgahların kesinlik, soğutma sıvısı ayrışabilirliği ve ekipman koruması gereksinimlerini karşılamak için özel olarak tasarlanmış üstün kaliteli kızak yağlarıdır. Mobil Vactra Oil Numbered Serisi, yüksek kaliteli baz yağlardan dikkatlice formüle edilmiştir ve kontrollü sürtünme özellikleri sağlayan, su ile karışan metal işleme sıvılarıyla uyumlu ve parçalarda ve ekipmanda korozyona karşı koruma sağlayan gelişmiş bir katkı sistemi ile performans dengesi`,
  },
  "therm-605": {
    name: "Mobil Therm 605", grade: "ISO VG 605", series: "Mobil Therm", type: "Isıl İşlem Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobiltherm ısı transfer yağları, kapalı dolaylı ısıtma sistemlerinde kullanmak için tasarlanmış yüksek performanslı ürünlerdir. Bu yağlar her tür endüstriyel proseslerdeki soğuk yağ sızdırmazlığı",
    features: ["bir etkendir.","Mobiltherm 600, aşağıdaki faydaları sağlar."],
    image: "/images/products/mobil/therm-605.jpg",
    fullDescription: `Mobiltherm ısı transfer yağları, kapalı dolaylı ısıtma sistemlerinde kullanmak için tasarlanmış yüksek performanslı ürünlerdir. Bu yağlar her tür endüstriyel proseslerdeki soğuk yağ sızdırmazlığı`,
  },
  "jet-oil-2": {
    name: "Mobil Jet Oil 2", grade: "2", series: "Mobil Jet Oil", type: "Havacılık Türbin Yağı",
    api: "Mil-PRF-23699 karşı Onaylı", acea: "",
    approvals: [],
    description: "Havacılık Türbin Yağı",
    features: ["Özellikleri","Avantajları ve Potansiyel Yararları","Tutar motor verimliliğini ve motor ömrünü uzatır","Azaltır, motor bakım","Kimyasal olarak stabil azaltır buharlaşma kayıpları ve yağ tüketimini azaltır","Uygulamalar"],
    image: "/images/products/mobil/jet-oil-2.jpg",
    fullDescription: ``,
  },
  "dte-oil-heavy-medium": {
    name: "Mobil DTE Oil Heavy Medium", grade: "", series: "Mobil DTE Oil Heavy Medium", type: "Mineral Yağlı Kompresör Yağı",
    api: "DIN 51515-1 L-TD (2001) X X X", acea: "DIN 51517 CL (1989) X X X",
    approvals: ["DIN 51524 HL (1985) X X X"],
    description: "Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna ",
    features: ["Beklenmeyen duruşları azaltır ve bakım maliyetlerini düşürür","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Aşınmaya karşı üstün koruma","Pas ve korozyona karşı uzun vadeli koruma"],
    image: "/images/products/mobil/dte-oil-heavy-medium.jpg",
    fullDescription: `Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna karşı yüksek dayanıklılığı sağlayan üst düzeyde rafine edilmiş baz yağlar ve katık sistemi ile formüle edilmiştir. Bu yağlar, pas ve korozyona karşı mükemmel koruma yanı sıra tuzlu suya karşı direnç v`,
  },
  "dte-oil-heavy": {
    name: "Mobil DTE Oil Heavy", grade: "", series: "Mobil DTE Oil Heavy", type: "Mineral Yağlı Kompresör Yağı",
    api: "DIN 51515-1 L-TD (2001) X X X", acea: "DIN 51517 CL (1989) X X X",
    approvals: ["DIN 51524 HL (1985) X X X"],
    description: "Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna ",
    features: ["Beklenmeyen duruşları azaltır ve bakım maliyetlerini düşürür","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Aşınmaya karşı üstün koruma","Pas ve korozyona karşı uzun vadeli koruma"],
    image: "/images/products/mobil/dte-oil-heavy.jpg",
    fullDescription: `Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna karşı yüksek dayanıklılığı sağlayan üst düzeyde rafine edilmiş baz yağlar ve katık sistemi ile formüle edilmiştir. Bu yağlar, pas ve korozyona karşı mükemmel koruma yanı sıra tuzlu suya karşı direnç v`,
  },
  "dte-oil-light": {
    name: "Mobil DTE Oil Light", grade: "", series: "Mobil DTE Oil Light", type: "Mineral Yağlı Kompresör Yağı",
    api: "DIN 51515-1 L-TD (2001) X X X", acea: "DIN 51517 CL (1989) X X X",
    approvals: ["DIN 51524 HL (1985) X X X"],
    description: "Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna ",
    features: ["Beklenmeyen duruşları azaltır ve bakım maliyetlerini düşürür","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Aşınmaya karşı üstün koruma","Pas ve korozyona karşı uzun vadeli koruma"],
    image: "/images/products/mobil/dte-oil-light.jpg",
    fullDescription: `Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna karşı yüksek dayanıklılığı sağlayan üst düzeyde rafine edilmiş baz yağlar ve katık sistemi ile formüle edilmiştir. Bu yağlar, pas ve korozyona karşı mükemmel koruma yanı sıra tuzlu suya karşı direnç v`,
  },
  "rarus-424": {
    name: "Mobil Rarus 424", grade: "ISO VG 424", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Kompresör Yağı",
    features: [],
    image: "/images/products/mobil/rarus-424.jpg",
    fullDescription: ``,
  },
  "gargoyle-arctic-300": {
    name: "Mobil Gargoyle Arctic 300", grade: "ISO VG 300", series: "Mobil Gargoyle Arctic", type: "Soğutma Kompresörü Yağı",
    api: "", acea: "",
    approvals: [],
    description: "C Heavy ve 300 ürünleri yüksek performanslı, esas olarak soğutma kompresörlerinde kullanılmak amacıyla geliştirilmiş naftenik mineral yağlardır. Wax içermedikleri için çok düşük akma noktasına ve düşük sıcaklıklarda mükemmel akıcılığa sahiptirler. Bunun sonucunda, Gargoyle Arctic yağlarının kullanıl",
    features: ["Özellikleri Üstünlükleri ve Sağlayacağı Faydalar","Düşük wax içeriği","İyi kimyasal kararlılık","Çok amaçlı yağlar"],
    image: "/images/products/mobil/gargoyle-arctic-300.jpg",
    fullDescription: `C Heavy ve 300 ürünleri yüksek performanslı, esas olarak soğutma kompresörlerinde kullanılmak amacıyla geliştirilmiş naftenik mineral yağlardır. Wax içermedikleri için çok düşük akma noktasına ve düşük sıcaklıklarda mükemmel akıcılığa sahiptirler. Bunun sonucunda, Gargoyle Arctic yağlarının kullanılması evaporatör borularının temiz kalmasını sağlayarak ısı transferini arttırır ve bakım için duruş sürelerini azaltır. Bu yağların çok iyi kimyasal kararlılığı vardır silindir ve rulman yağlaması içi`,
  },
  "gargoyle-arctic-shc-226e": {
    name: "Mobil Gargoyle Arctic SHC 226E", grade: "226E", series: "Mobil Gargoyle Arctic SHC", type: "Soğutma Kompresörü Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karş",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","az sayıda periyodik bakım sağlar","Mükemmel ısıl/oksidasyon ve kimyasal kararlılık","Düşük buharlaşma Viskozite artışını engeller, yağ tüketimini azaltır","Yüksek Viskozite indeksi ve wax içermeyen bileşim","Düşük çekme gerilim katsayısı"],
    image: "/images/products/mobil/gargoyle-arctic-shc-226e.jpg",
    fullDescription: `Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karşı üstün dirence sahip sentetik hidrokarbon polialfaolefin (PAO) sıvılarından formüle edilmiştir. Doğal olarak sahip oldukları kesme dayanımlı yüksek viskozite indeksi ve düşük sıcaklıklardaki kolay ak`,
  },
  "eal-arctic-68": {
    name: "Mobil EAL Arctic 68", grade: "ISO VG 68", series: "Mobil EAL Arctic", type: "Çevreci Soğutma Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yer",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","gerekli özel viskozite gereksinimlerini karşılar","Geniş viskozite aralığı"],
    image: "/images/products/mobil/eal-arctic-68.jpg",
    fullDescription: `Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yerine kullanılan ürünlerdir). Mobil EAL Arctic Serisi yağlar benzersiz yağlama, aşınmaya karşı koruma, kimyasal, ısıl ve hidrolik kararlılık sağlaması amacıyla özel sentetik poliol esterleri (POE'ler) v`,
  },
  "eal-arctic-32": {
    name: "Mobil EAL Arctic 32", grade: "ISO VG 32", series: "Mobil EAL Arctic", type: "Çevreci Soğutma Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yer",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","gerekli özel viskozite gereksinimlerini karşılar","Geniş viskozite aralığı"],
    image: "/images/products/mobil/eal-arctic-32.jpg",
    fullDescription: `Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yerine kullanılan ürünlerdir). Mobil EAL Arctic Serisi yağlar benzersiz yağlama, aşınmaya karşı koruma, kimyasal, ısıl ve hidrolik kararlılık sağlaması amacıyla özel sentetik poliol esterleri (POE'ler) v`,
  },
  "rarus-425": {
    name: "Mobil Rarus 425", grade: "ISO VG 425", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "DIN 51506 VD-L (RWTUEV onaylı)", acea: "",
    approvals: [],
    description: "Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması v",
    features: ["Supap performansı artar","Çıkış hatlarında daha az tortu oluşur","Daha yüksek kompresör performansı sağlar","Daha uzun yağ ömrü sağlar","Filtre ömrünü artırır","Yüksek yük-taşıma kapasitesi"],
    image: "/images/products/mobil/rarus-425.jpg",
    fullDescription: `Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması ve güvenirliği sağlamak üzere tasarlanmış yüksek performanslı katık sistemi ile formüle edilmişlerdir. Bu yağlar ekipman sorunlarını ve tortu oluşumunu ve taşınmasını en aza indirerek aşınmaya karşı mü`,
  },
  "rarus-shc-1026": {
    name: "Mobil Rarus SHC 1026", grade: "1026", series: "Mobil Rarus SHC", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Rarus SHC 1000 Serisi üstün performanslı yağlar esas olarak ağır hizmet rotari vidalı ve kanatlı hava kompresörlerini yağlama amacıyla geliştirilmiş bir seridir. Bu yağlar, özellikle mineral bazlı ürünlerin yüksek son kompresyon sıcaklıkları altındaki güç çalışma uygulamaları veya yağ değiştir",
    features: ["Geniş çalışma sıcaklığı aralığı","Güvenlik artışı","Uzun servis ömrü","Kok tortularını azaltır","Yağ ömrünü uzatır","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/rarus-shc-1026.jpg",
    fullDescription: `Mobil Rarus SHC 1000 Serisi üstün performanslı yağlar esas olarak ağır hizmet rotari vidalı ve kanatlı hava kompresörlerini yağlama amacıyla geliştirilmiş bir seridir. Bu yağlar, özellikle mineral bazlı ürünlerin yüksek son kompresyon sıcaklıkları altındaki güç çalışma uygulamaları veya yağ değiştirme aralıklarının uzatılması taleplerini karşılayamadığı durumlar için uygundur. Bunlar özel olarak tasarlanmış wax içermeyen sentetik hidrokarbon sıvıları ve mineral bazlı hava kompresörleri yağlarını`,
  },
  "rarus-shc-1025": {
    name: "Mobil Rarus SHC 1025", grade: "1025", series: "Mobil Rarus SHC", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Rarus SHC 1000 Serisi üstün performanslı yağlar esas olarak ağır hizmet rotari vidalı ve kanatlı hava kompresörlerini yağlama amacıyla geliştirilmiş bir seridir. Bu yağlar, özellikle mineral bazlı ürünlerin yüksek son kompresyon sıcaklıkları altındaki güç çalışma uygulamaları veya yağ değiştir",
    features: ["Geniş çalışma sıcaklığı aralığı","Güvenlik artışı","Uzun servis ömrü","Kok tortularını azaltır","Yağ ömrünü uzatır","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/rarus-shc-1025.jpg",
    fullDescription: `Mobil Rarus SHC 1000 Serisi üstün performanslı yağlar esas olarak ağır hizmet rotari vidalı ve kanatlı hava kompresörlerini yağlama amacıyla geliştirilmiş bir seridir. Bu yağlar, özellikle mineral bazlı ürünlerin yüksek son kompresyon sıcaklıkları altındaki güç çalışma uygulamaları veya yağ değiştirme aralıklarının uzatılması taleplerini karşılayamadığı durumlar için uygundur. Bunlar özel olarak tasarlanmış wax içermeyen sentetik hidrokarbon sıvıları ve mineral bazlı hava kompresörleri yağlarını`,
  },
  "eal-arctic-46": {
    name: "Mobil EAL Arctic 46", grade: "ISO VG 46", series: "Mobil EAL Arctic", type: "Çevreci Soğutma Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yer",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","gerekli özel viskozite gereksinimlerini karşılar","Geniş viskozite aralığı"],
    image: "/images/products/mobil/eal-arctic-46.jpg",
    fullDescription: `Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yerine kullanılan ürünlerdir). Mobil EAL Arctic Serisi yağlar benzersiz yağlama, aşınmaya karşı koruma, kimyasal, ısıl ve hidrolik kararlılık sağlaması amacıyla özel sentetik poliol esterleri (POE'ler) v`,
  },
  "socony-oven-conveyer-lubricant": {
    name: "Mobil Socony Oven Conveyer Lubricant", grade: "", series: "Mobil Socony Oven Conveyer Lubricant", type: "Fırın Konveyör Yağlayıcısı",
    api: "", acea: "",
    approvals: [],
    description: "Socony Fırın Zincirleme Yağ 200 santigrat sıcaklığa kadar fırın konveyör zincirleri yağlanması için özel olarak tasarlanmış yüksek performanslı bir üründür. Bu düşük viskoziteli bir yağla ve koloidal grafit formüle edilmiştir. Yağ, grafit için bir taşıyıcı olarak hareket eder ve hareketli parçalar a",
    features: ["Özellikler","Avantajları ve Potansiyel Yararları","Grafit, katı filmin çok iyi yağlama özellikleri","Zincir bağlantıları ve iğnelerden iyi penetrasyon","Yapışmasına neden olabilir mevduat olmaması","Uygulamalar"],
    image: "/images/products/mobil/socony-oven-conveyer-lubricant.jpg",
    fullDescription: `Socony Fırın Zincirleme Yağ 200 santigrat sıcaklığa kadar fırın konveyör zincirleri yağlanması için özel olarak tasarlanmış yüksek performanslı bir üründür. Bu düşük viskoziteli bir yağla ve koloidal grafit formüle edilmiştir. Yağ, grafit için bir taşıyıcı olarak hareket eder ve hareketli parçalar arasında nüfuz edebilir. Yağ. Yapışma neden olabilecek kalıntı bırakmadan buharlaşmaya çalışma sıcaklığında uçucudur Socony fırın konveyör Lubricant akışkan bağlantılar ve pimlerin arasına nüfuz sağlam`,
  },
  "vacuoline-546": {
    name: "Mobil Vacuoline 546", grade: "ISO VG 546", series: "Mobil Vacuoline", type: "Dolaşım Sistemi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri v",
    features: ["Daha az programsız duruş ve düşük bakım maliyeti sağlar","Benzersiz aşınma önleme performansı","Mükemmel sudan ayrılma özellikleri","Yüksek oksidasyon ve ısıl bozunma mukavemeti","Dünya çapında güvenilir performans gösterir"],
    image: "/images/products/mobil/vacuoline-546.jpg",
    fullDescription: `Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri ve yatakların sirkülasyonlu sistemle yağlanması konusunda mükemmel bir seçenek yapar. Mobil Vacuoline 500 Serisi Morgan Construction Company’nin yüksek hızlı No-Twist Çubuk Haddelerinin kritik talepler`,
  },
  "vacuoline-537": {
    name: "Mobil Vacuoline 537", grade: "ISO VG 537", series: "Mobil Vacuoline", type: "Dolaşım Sistemi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri v",
    features: ["Daha az programsız duruş ve düşük bakım maliyeti sağlar","Benzersiz aşınma önleme performansı","Mükemmel sudan ayrılma özellikleri","Yüksek oksidasyon ve ısıl bozunma mukavemeti","Dünya çapında güvenilir performans gösterir"],
    image: "/images/products/mobil/vacuoline-537.jpg",
    fullDescription: `Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri ve yatakların sirkülasyonlu sistemle yağlanması konusunda mükemmel bir seçenek yapar. Mobil Vacuoline 500 Serisi Morgan Construction Company’nin yüksek hızlı No-Twist Çubuk Haddelerinin kritik talepler`,
  },
  "vacuoline-533": {
    name: "Mobil Vacuoline 533", grade: "ISO VG 533", series: "Mobil Vacuoline", type: "Dolaşım Sistemi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Ürünün Eski İsmi: Mobil DTE Oil BB - VG220 Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ",
    features: ["Daha az programsız duruş ve düşük bakım maliyeti sağlar","Benzersiz aşınma önleme performansı","Mükemmel sudan ayrılma özellikleri","Yüksek oksidasyon ve ısıl bozunma mukavemeti","Dünya çapında güvenilir performans gösterir"],
    image: "/images/products/mobil/vacuoline-533.jpg",
    fullDescription: `Ürünün Eski İsmi: Mobil DTE Oil BB - VG220 Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri ve yatakların sirkülasyonlu sistemle yağlanması konusunda mükemmel bir seçenek yapar. Mobil Vacuoline 500 Serisi Morgan Construction Company’nin yüksek hızlı`,
  },
  "vacuoline-528": {
    name: "Mobil Vacuoline 528", grade: "ISO VG 528", series: "Mobil Vacuoline", type: "Dolaşım Sistemi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri v",
    features: ["Daha az programsız duruş ve düşük bakım maliyeti sağlar","Benzersiz aşınma önleme performansı","Mükemmel sudan ayrılma özellikleri","Yüksek oksidasyon ve ısıl bozunma mukavemeti","Dünya çapında güvenilir performans gösterir"],
    image: "/images/products/mobil/vacuoline-528.jpg",
    fullDescription: `Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri ve yatakların sirkülasyonlu sistemle yağlanması konusunda mükemmel bir seçenek yapar. Mobil Vacuoline 500 Serisi Morgan Construction Company’nin yüksek hızlı No-Twist Çubuk Haddelerinin kritik talepler`,
  },
  "vacuoline-525": {
    name: "Mobil Vacuoline 525", grade: "ISO VG 525", series: "Mobil Vacuoline", type: "Dolaşım Sistemi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri v",
    features: ["Daha az programsız duruş ve düşük bakım maliyeti sağlar","Benzersiz aşınma önleme performansı","Mükemmel sudan ayrılma özellikleri","Yüksek oksidasyon ve ısıl bozunma mukavemeti","Dünya çapında güvenilir performans gösterir"],
    image: "/images/products/mobil/vacuoline-525.jpg",
    fullDescription: `Movil Vacuoline 500 Serisine ait ürünler geniş bir endüstriyel ekipman çeşidi için çok yönlü yağlama imkanı sağlar.  Mobil Vacuoline 500 Serisi yağlayıcıları, No-Twist Çubuk haddelerinin ihtiyaçları için tasarlanmış olan ağır hizmet sirkülasyon yağlarıdır, ancak performansları bu yağları dişlileri ve yatakların sirkülasyonlu sistemle yağlanması konusunda mükemmel bir seçenek yapar. Mobil Vacuoline 500 Serisi Morgan Construction Company’nin yüksek hızlı No-Twist Çubuk Haddelerinin kritik talepler`,
  },
  "velocite-oil-no-6": {
    name: "Mobil Velocite Oil No 6", grade: "6", series: "Mobil Velocite Oil No", type: "Mil Yağı",
    api: "Cincinnati Machine P-65", acea: "Cincinnati Machine P-62",
    approvals: ["Cincinnati Machine P-45"],
    description: "Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. B",
    features: ["Yüksek oksidasyon direnci","Yağ ömrünü uzatır","Ekipman ömrünü uzatır","Etkili sudan ayrılma","Emülsiyon oluşumunu engeller","Nemi kritik yağlama alanlarından uzak tutar"],
    image: "/images/products/mobil/velocite-oil-no-6.jpg",
    fullDescription: `Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. Bu yağlar özel olarak seçilmiş yüksek kaliteli, düşük viskoziteli baz yağlar ve oksidasyon, pas ve korozyona karşı iyi direnç sağlayan katıklar ile formüle edilmiştir. Bu yağların köpük oluşumuna karşı`,
  },
  "velocite-oil-no-3": {
    name: "Mobil Velocite Oil No 3", grade: "3", series: "Mobil Velocite Oil No", type: "Mil Yağı",
    api: "Cincinnati Machine P-65", acea: "Cincinnati Machine P-62",
    approvals: ["Cincinnati Machine P-45"],
    description: "Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. B",
    features: ["Yüksek oksidasyon direnci","Yağ ömrünü uzatır","Ekipman ömrünü uzatır","Etkili sudan ayrılma","Emülsiyon oluşumunu engeller","Nemi kritik yağlama alanlarından uzak tutar"],
    image: "/images/products/mobil/velocite-oil-no-3.jpg",
    fullDescription: `Mobil Velocite Oil Serisi özel olarak takım tezgahlarında yüksek devirli millerin yağlanması amacıyla tasarlanmış üstün performanslı yağlardır. Bunlar uygun viskozite sınıfı seçildiğinde aynı zamanda bazı kritik hidrolik, merkezi yağlama sistemleri ve hava hatlarının yağlanması için de kullanılır. Bu yağlar özel olarak seçilmiş yüksek kaliteli, düşük viskoziteli baz yağlar ve oksidasyon, pas ve korozyona karşı iyi direnç sağlayan katıklar ile formüle edilmiştir. Bu yağların köpük oluşumuna karşı`,
  },
  "met-762": {
    name: "Mobil Met 762", grade: "ISO VG 762", series: "Mobil Met", type: "Metal İşleme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Ö",
    features: ["Mükemmel parça işleme performansı","Mükemmel yağlama özelliği","Çok amaçlı kullanım","Açık renkli ve saydam görünüm","Yağ sisini önleyen formülasyon","Çalışma yeri güvenliğini artırır"],
    image: "/images/products/mobil/met-762.jpg",
    fullDescription: `Mobilmet™ 760 Serisi ekstra yüksek performanslı düz kesme yağlarıdır. Klorin içermezler. İişlenmesi güç takım çelikleri üzerinde yapılacak zor kesme işlemleri için geliştirilmişlerdir. . Mobilmet 760 Serisi yağlar, yumuşak sarı metallere karşı agresif olduğundan bakır ve alaşımları için önerilmez. Önde gelen diğer üstün kalite kesme yağlarına kıyasla Mobilmet 760 Serisi, yüzey kalitesi, takım ömrünü artırma ve uç kaynama kontrolü açısından üstün performans sergilerler. Açık renkleri sayesinde iş`,
  },
  "arma-798": {
    name: "Mobil Arma 798", grade: "ISO VG 798", series: "Mobil Arma", type: "Ağır Dişli ve Kablo Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilarma 798 tel halat yağlayıcı olarak hizmet etmek ve uygulama ve depolama koşulları altında pas ve korozyonu önlemek amacıyla önleyici bir prim performans, yağ bazlı pas olduğunu. Bu sanayi, madencilik, ve deniz uygulamalarında kullanılmaktadır. Mobilarma 798 mükemmel film oluşturucu özellikleri",
    features: ["Özellikler","Üstün yapıştırıcı özellikleri","Dayanıklıdır atmak-off","Mükemmel pas ve korozyon koruması",", hafif asitlere karşı saldırı halatı korur","Aşınma azaltır"],
    image: "/images/products/mobil/arma-798.jpg",
    fullDescription: `Mobilarma 798 tel halat yağlayıcı olarak hizmet etmek ve uygulama ve depolama koşulları altında pas ve korozyonu önlemek amacıyla önleyici bir prim performans, yağ bazlı pas olduğunu. Bu sanayi, madencilik, ve deniz uygulamalarında kullanılmaktadır. Mobilarma 798 mükemmel film oluşturucu özellikleri vardır ve gres yağı benzeri bir kıvama sahiptir. Onun inatçı filmi tuz spreyi ve rutubetli ortamlarda aşındırıcı eğilimlerden halat korur. Mobilarma 798 denizde karşılaşılabilecek sıcaklıklarının aşı`,
  },
  "nuto-h-46": {
    name: "Mobil Nuto H 46", grade: "ISO VG 46", series: "Mobil Nuto H", type: "Hidrolik Yağ",
    api: "", acea: "",
    approvals: [],
    description: "Nuto™ H Serisi yağlar, aşırı olmayan çalışma koşullarına maruz kalan ve aşınma önleyici yağlara ihtiyaç duyulan endüstriyel ve hareketli hizmet uygulamaları için tasarlanmış iyi kalitede aşınma önleyici hidrolik yağlardır. Etkili oksidasyon direnci ve kimyasal kararlılıkları, hafiften ağır şartlara ",
    features: [],
    image: "/images/products/mobil/nuto-h-46.jpg",
    fullDescription: `Nuto™ H Serisi yağlar, aşırı olmayan çalışma koşullarına maruz kalan ve aşınma önleyici yağlara ihtiyaç duyulan endüstriyel ve hareketli hizmet uygulamaları için tasarlanmış iyi kalitede aşınma önleyici hidrolik yağlardır. Etkili oksidasyon direnci ve kimyasal kararlılıkları, hafiften ağır şartlara kadarki tüm uygulamalarda bu yağlara uzun hizmet ömrü sağlar.`,
  },
  "dte-22": {
    name: "Mobil DTE 22", grade: "ISO VG 22", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Mobil Dte 22 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-22.jpg",
    fullDescription: `Mobil Dte 22 çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında`,
  },
  "delvac-hydraulic-10w": {
    name: "Mobil Delvac Hydraulic 10W", grade: "10W", series: "Mobil Delvac Hydraulic", type: "Hidrolik Yağ",
    api: "Vickers 35VQ25", acea: "API CD/SF",
    approvals: [],
    description: "Mobil Delvac Hydraulic 10W, çok çeşitli ağır hizmet hidrolik ekipmanlarının gereksinimlerini karşılamak üzere tasarlanmış ileri teknoloji ile üretilmiş baz yağlar ve dengeli bir katık sistemi ile formüle edilmiş yüksek performanslı hidrolik yağıdır. Bu ürün özellikle kül içermeyen dispersanlar ve me",
    features: ["Özellikle pompa kanatları ve kontrol valflerinde daha az aşınma","Pompa kanadı yapışmasına karşı korur","Yağ analizleri ile yağ değişim aralıklarını uzatır","İyi aşınma önleme özelliği     Erken aşınmayı azaltır ve ekipman ömrünü uzatır","Yüksek sıcaklıklarda etkili yağ filmi mukavemeti sağlar"],
    image: "/images/products/mobil/delvac-hydraulic-10w.jpg",
    fullDescription: `Mobil Delvac Hydraulic 10W, çok çeşitli ağır hizmet hidrolik ekipmanlarının gereksinimlerini karşılamak üzere tasarlanmış ileri teknoloji ile üretilmiş baz yağlar ve dengeli bir katık sistemi ile formüle edilmiş yüksek performanslı hidrolik yağıdır. Bu ürün özellikle kül içermeyen dispersanlar ve metalik deterjanlar ile oksidasyon, aşınma, korozyon ve paslanmayı kontrol eden koruyucuların etkili dengesiyle özel olarak geliştirilmiştir. Mobil Delvac Hydraulic 10W, yol ve arazi şartlarında bulunan`,
  },
  "dte-oil-medium": {
    name: "Mobil DTE Oil Medium", grade: "", series: "Mobil DTE Oil Medium", type: "Mineral Yağlı Kompresör Yağı",
    api: "DIN 51515-1 L-TD (2001) X X X", acea: "DIN 51517 CL (1989) X X X",
    approvals: ["DIN 51524 HL (1985) X X X"],
    description: "Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna ",
    features: ["Beklenmeyen duruşları azaltır ve bakım maliyetlerini düşürür","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Aşınmaya karşı üstün koruma","Pas ve korozyona karşı uzun vadeli koruma"],
    image: "/images/products/mobil/dte-oil-medium.jpg",
    fullDescription: `Mobil DTE Oil Serisi, uzun yağ servis ömrünün gerektiği ve aralarında buhar ve su türbin gruplarının yer aldığı uygulamalar için tasarlanmış üstün performanslı sirkülasyon yağlarıdır. Mobil DTE Oil Serisi yağlar olağanüstü kimyasal ve ısıl kararlılık, sudan hızlı ve tam ayrılma, emülsiyon oluşumuna karşı yüksek dayanıklılığı sağlayan üst düzeyde rafine edilmiş baz yağlar ve katık sistemi ile formüle edilmiştir. Bu yağlar, pas ve korozyona karşı mükemmel koruma yanı sıra tuzlu suya karşı direnç v`,
  },
  "dte-797": {
    name: "Mobil DTE 797", grade: "ISO VG 797", series: "Mobil DTE", type: "Ağır Hizmet Dolaşım Yağı",
    api: "ASTM 4304 Type I ve III", acea: "DIN 51515 L-TD",
    approvals: ["DIN 51515 L-TG","ISO 8068 L-TGB (Kalite Düzeyi)","ISO 8068 L-TGSB (Kalite Düzeyi)"],
    description: "Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DT",
    features: ["Üstün oksidasyon, kimyasal ve renk kararlılığı","Üstün türbin sistemi güvenilirlik seviyesi ve azaltılmış arıza duruş süreleri","Mükemmel sudan ayrılabilirlik","Geliştirilmiş pas ve korozyon koruması","Hızlı hava bırakma ve köpük oluşumunu engelleme","Çinkosuz (Zinc Free)"],
    image: "/images/products/mobil/dte-797.jpg",
    fullDescription: `Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DTE 700 Serisi yağlar, antioksidanlar, pas ve korozyon inhibitörleri ve köpük önleyici maddelerini de içeren özenle seçilmiş olan bazyağlar ve katıklarla formüle edilmişlerdir. Bu bileşenler zaman içind`,
  },
  "dte-846": {
    name: "Mobil DTE 846", grade: "ISO VG 846", series: "Mobil DTE", type: "Ağır Hizmet Dolaşım Yağı",
    api: "DIN 51515-1 L-TD karşılar veya geçer X", acea: "DIN 51515-2 L-TG karşılar veya geçer X",
    approvals: [],
    description: "Mobil DTE 832 ve 846 yağları buhar türbini, gaz türbini ve kombine çevrimli gaz türbinlerinin (CCGT) karşı karşıya kaldığı en zor çalışma koşulları altında kullanılmak üzere tasarlanmıştır. Bu yenilikçi ürünler özgün yöntemlerle hidrojen işlemlerinden geçirilmiş üstün ısıl/oksidasyon mukavemeti sağl",
    features: ["Yanlış yağ uygulama olasılığını önler, masraflı yağ değişimlerini azaltır","Stok maliyetlerini azaltır","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Yağ değişme aralığını artırır, üretim maliyetlerini düşürür","Aşınmaya karşı mükemmel koruma","Ekipman ömrünü uzatır, parça değişim maliyetini düşürür"],
    image: "/images/products/mobil/dte-846.jpg",
    fullDescription: `Mobil DTE 832 ve 846 yağları buhar türbini, gaz türbini ve kombine çevrimli gaz türbinlerinin (CCGT) karşı karşıya kaldığı en zor çalışma koşulları altında kullanılmak üzere tasarlanmıştır. Bu yenilikçi ürünler özgün yöntemlerle hidrojen işlemlerinden geçirilmiş üstün ısıl/oksidasyon mukavemeti sağlayan çok yüksek kaliteli baz yağlar ile zor koşullar altında çalışan gaz türbinleri için gerekli tortu kontrolü ve "temiz tutma” performansı ile bunun yanı sıra buhar türbini işletmesi için gereken mü`,
  },
  "dte-832": {
    name: "Mobil DTE 832", grade: "ISO VG 832", series: "Mobil DTE", type: "Ağır Hizmet Dolaşım Yağı",
    api: "DIN 51515-1 L-TD karşılar veya geçer X", acea: "DIN 51515-2 L-TG karşılar veya geçer X",
    approvals: [],
    description: "Mobil DTE 832 ve 846 yağları buhar türbini, gaz türbini ve kombine çevrimli gaz türbinlerinin (CCGT) karşı karşıya kaldığı en zor çalışma koşulları altında kullanılmak üzere tasarlanmıştır. Bu yenilikçi ürünler özgün yöntemlerle hidrojen işlemlerinden geçirilmiş üstün ısıl/oksidasyon mukavemeti sağl",
    features: ["Yanlış yağ uygulama olasılığını önler, masraflı yağ değişimlerini azaltır","Stok maliyetlerini azaltır","Özellikleri Avantajları ve Sağlayabileceği Faydalar","Yağ değişme aralığını artırır, üretim maliyetlerini düşürür","Aşınmaya karşı mükemmel koruma","Ekipman ömrünü uzatır, parça değişim maliyetini düşürür"],
    image: "/images/products/mobil/dte-832.jpg",
    fullDescription: `Mobil DTE 832 ve 846 yağları buhar türbini, gaz türbini ve kombine çevrimli gaz türbinlerinin (CCGT) karşı karşıya kaldığı en zor çalışma koşulları altında kullanılmak üzere tasarlanmıştır. Bu yenilikçi ürünler özgün yöntemlerle hidrojen işlemlerinden geçirilmiş üstün ısıl/oksidasyon mukavemeti sağlayan çok yüksek kaliteli baz yağlar ile zor koşullar altında çalışan gaz türbinleri için gerekli tortu kontrolü ve "temiz tutma” performansı ile bunun yanı sıra buhar türbini işletmesi için gereken mü`,
  },
  "shc-rarus-68": {
    name: "Mobil SHC Rarus 68", grade: "ISO VG 68", series: "Mobil SHC Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil SHC Rarus 68 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı",
    features: ["Tipik Özellikler"],
    image: "/images/products/mobil/shc-rarus-68.jpg",
    fullDescription: `Mobil SHC Rarus 68 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı`,
  },
  "shc-rarus-46": {
    name: "Mobil SHC Rarus 46", grade: "ISO VG 46", series: "Mobil SHC Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil SHC Rarus 46 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı",
    features: ["Tipik Özellikler"],
    image: "/images/products/mobil/shc-rarus-46.jpg",
    fullDescription: `Mobil SHC Rarus 46 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı`,
  },
  "shc-rarus-32": {
    name: "Mobil SHC Rarus 32", grade: "ISO VG 32", series: "Mobil SHC Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil SHC Rarus 32 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı",
    features: ["Tipik Özellikler"],
    image: "/images/products/mobil/shc-rarus-32.jpg",
    fullDescription: `Mobil SHC Rarus 32 Vidalı Kompresör Yağı Yeni nesil sentetik hava kompresörü yağı`,
  },
  "gargoyle-arctic-155": {
    name: "Mobil Gargoyle Arctic 155", grade: "ISO VG 155", series: "Mobil Gargoyle Arctic", type: "Soğutma Kompresörü Yağı",
    api: "", acea: "",
    approvals: [],
    description: "C Heavy ve 300 ürünleri yüksek performanslı, esas olarak soğutma kompresörlerinde kullanılmak amacıyla geliştirilmiş naftenik mineral yağlardır. Wax içermedikleri için çok düşük akma noktasına ve düşük sıcaklıklarda mükemmel akıcılığa sahiptirler. Bunun sonucunda, Gargoyle Arctic yağlarının kullanıl",
    features: ["Özellikleri Üstünlükleri ve Sağlayacağı Faydalar","Düşük wax içeriği","İyi kimyasal kararlılık","Çok amaçlı yağlar"],
    image: "/images/products/mobil/gargoyle-arctic-155.jpg",
    fullDescription: `C Heavy ve 300 ürünleri yüksek performanslı, esas olarak soğutma kompresörlerinde kullanılmak amacıyla geliştirilmiş naftenik mineral yağlardır. Wax içermedikleri için çok düşük akma noktasına ve düşük sıcaklıklarda mükemmel akıcılığa sahiptirler. Bunun sonucunda, Gargoyle Arctic yağlarının kullanılması evaporatör borularının temiz kalmasını sağlayarak ısı transferini arttırır ve bakım için duruş sürelerini azaltır. Bu yağların çok iyi kimyasal kararlılığı vardır silindir ve rulman yağlaması içi`,
  },
  "gargoyle-arctic-shc-230": {
    name: "Mobil Gargoyle Arctics SHC 230", grade: "ISO VG 230", series: "Mobil Gargoyle Arctics SHC", type: "Soğutma Kompresörü Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karş",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","az sayıda periyodik bakım sağlar","Mükemmel ısıl/oksidasyon ve kimyasal kararlılık","Düşük buharlaşma Viskozite artışını engeller, yağ tüketimini azaltır","Yüksek Viskozite indeksi ve wax içermeyen bileşim","Düşük çekme gerilim katsayısı"],
    image: "/images/products/mobil/gargoyle-arctic-shc-230.jpg",
    fullDescription: `Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karşı üstün dirence sahip sentetik hidrokarbon polialfaolefin (PAO) sıvılarından formüle edilmiştir. Doğal olarak sahip oldukları kesme dayanımlı yüksek viskozite indeksi ve düşük sıcaklıklardaki kolay ak`,
  },
  "eal-arctic-100": {
    name: "Mobil EAL Arctic 100", grade: "ISO VG 100", series: "Mobil EAL Arctic", type: "Çevreci Soğutma Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yer",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","gerekli özel viskozite gereksinimlerini karşılar","Geniş viskozite aralığı"],
    image: "/images/products/mobil/eal-arctic-100.jpg",
    fullDescription: `Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yerine kullanılan ürünlerdir). Mobil EAL Arctic Serisi yağlar benzersiz yağlama, aşınmaya karşı koruma, kimyasal, ısıl ve hidrolik kararlılık sağlaması amacıyla özel sentetik poliol esterleri (POE'ler) v`,
  },
  "rarus-429": {
    name: "Mobil Rarus 429", grade: "ISO VG 429", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "DIN 51506 VD-L (RWTUEV onaylı)", acea: "",
    approvals: [],
    description: "Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması v",
    features: ["Supap performansı artar","Çıkış hatlarında daha az tortu oluşur","Daha yüksek kompresör performansı sağlar","Daha uzun yağ ömrü sağlar","Filtre ömrünü artırır","Yüksek yük-taşıma kapasitesi"],
    image: "/images/products/mobil/rarus-429.jpg",
    fullDescription: `Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması ve güvenirliği sağlamak üzere tasarlanmış yüksek performanslı katık sistemi ile formüle edilmişlerdir. Bu yağlar ekipman sorunlarını ve tortu oluşumunu ve taşınmasını en aza indirerek aşınmaya karşı mü`,
  },
  "rarus-426": {
    name: "Mobil Rarus 426", grade: "ISO VG 426", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "DIN 51506 VD-L (RWTUEV onaylı)", acea: "",
    approvals: [],
    description: "Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması v",
    features: ["Supap performansı artar","Çıkış hatlarında daha az tortu oluşur","Daha yüksek kompresör performansı sağlar","Daha uzun yağ ömrü sağlar","Filtre ömrünü artırır","Yüksek yük-taşıma kapasitesi"],
    image: "/images/products/mobil/rarus-426.jpg",
    fullDescription: `Mobil Rarus 400 Serisi önde gelen kompresör imalatçılarının talep ettiği zorlu gereksinimleri karşılamak üzere tasarlanmış üstün performanslı külsüz hava kompresörü yağlarıdır. Yüksek kaliteli mineral baz yağlar ile orta ve ağır koşullar altında çalışan kompresörler için benzersiz ekipman koruması ve güvenirliği sağlamak üzere tasarlanmış yüksek performanslı katık sistemi ile formüle edilmişlerdir. Bu yağlar ekipman sorunlarını ve tortu oluşumunu ve taşınmasını en aza indirerek aşınmaya karşı mü`,
  },
  "nuto-h-68": {
    name: "Mobil Nuto H 68", grade: "ISO VG 68", series: "Mobil Nuto H", type: "Hidrolik Yağ",
    api: "", acea: "",
    approvals: [],
    description: "Nuto™ H Serisi yağlar, aşırı olmayan çalışma koşullarına maruz kalan ve aşınma önleyici yağlara ihtiyaç duyulan endüstriyel ve hareketli hizmet uygulamaları için tasarlanmış iyi kalitede aşınma önleyici hidrolik yağlardır. Etkili oksidasyon direnci ve kimyasal kararlılıkları, hafiften ağır şartlara ",
    features: [],
    image: "/images/products/mobil/nuto-h-68.jpg",
    fullDescription: `Nuto™ H Serisi yağlar, aşırı olmayan çalışma koşullarına maruz kalan ve aşınma önleyici yağlara ihtiyaç duyulan endüstriyel ve hareketli hizmet uygulamaları için tasarlanmış iyi kalitede aşınma önleyici hidrolik yağlardır. Etkili oksidasyon direnci ve kimyasal kararlılıkları, hafiften ağır şartlara kadarki tüm uygulamalarda bu yağlara uzun hizmet ömrü sağlar.`,
  },
  "dte-21": {
    name: "Mobil DTE 21", grade: "ISO VG 21", series: "Mobil DTE", type: "Dolaşım Sistemi Yağı",
    api: "FZG Dişli Testi, DIN 51354 - Yük Kademesi", acea: "DIN 51524 Part 2 (2006)",
    approvals: ["Cincinnati Machine","Vickers I-286-S","Vickers M-2950-S","Denison HF-0, HF-1, HF-2"],
    description: "Çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-",
    features: ["Özellikleri","Aşınmaya karşı koruma","Aşınmayı azaltır","Kalitesini koruma","Oksidasyon kararlılığı","Filtre ömrünü uzatır"],
    image: "/images/products/mobil/dte-21.jpg",
    fullDescription: `Çok değişik ve çeşitli hidrolik ekipman taleplerini karşılamak için tasarlanmış üstün performanslı aşınma önleyici hidrolik yağlardır. Bu yağlar uzun yağ/filtre ömrü ve optimum ekipman koruması sağlayarak, hem bakım hem de kullanılmış yağ atık maliyetlerini düşürürler.  Dar toleranslara sahip servo-valflar ve yüksek hassasiyetteki sayısal kontrollu (NC) takım tezgahlarındaki gibi diğer hidrolik sistem parçalarının kritik gereksinimlerini karşılamanın yanı sıra, zor koşullar altında yüksek basınç`,
  },
  "eal-arctic-22": {
    name: "Mobil EAL Arctic 22", grade: "ISO VG 22", series: "Mobil EAL Arctic", type: "Çevreci Soğutma Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yer",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","gerekli özel viskozite gereksinimlerini karşılar","Geniş viskozite aralığı"],
    image: "/images/products/mobil/eal-arctic-22.jpg",
    fullDescription: `Mobil EAL Arctic Serisi yüksek performanslı Çevreye Duyarlı Yağlar (EAL), özellikle ozon dostu HFC soğutucu  kullanan soğutma kompresörleri ve sistemlerinin yağlanması için özel olarak tasarlanmış tam sentetik ürünlerdir (HFC'ler klorin içermeyen ve dünya pazarlarında klorin içeren soğutucuların yerine kullanılan ürünlerdir). Mobil EAL Arctic Serisi yağlar benzersiz yağlama, aşınmaya karşı koruma, kimyasal, ısıl ve hidrolik kararlılık sağlaması amacıyla özel sentetik poliol esterleri (POE'ler) v`,
  },
  "somentor-ah-70": {
    name: "Mobil Somentor AH 70", grade: "ISO VG 70", series: "Mobil Somentor AH", type: "Makine Dairesi Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Somentor AH 45, AH 70 ve AL 70 Demirli ve demirsiz metallerin soğuk haddeleme için uygun tam bileşik yağlar, üstün kalite. Bu yağlar yüksek kaliteli baz yağlar ve bu uygulamaların zorlu performans gereksinimlerini karşılamak için özel olarak seçilen rulo yağ katkı maddeleri ile formüle edilmiştir.",
    features: ["Haddelenmiş metal parlak bir yüzey teslim","Yağın ömrünü uzatmak için kolay filtrasyon","Metallerin geniş bir aralığı için uygun","Uygulamalar"],
    image: "/images/products/mobil/somentor-ah-70.jpg",
    fullDescription: `Somentor AH 45, AH 70 ve AL 70 Demirli ve demirsiz metallerin soğuk haddeleme için uygun tam bileşik yağlar, üstün kalite. Bu yağlar yüksek kaliteli baz yağlar ve bu uygulamaların zorlu performans gereksinimlerini karşılamak için özel olarak seçilen rulo yağ katkı maddeleri ile formüle edilmiştir.`,
  },
  "aero-hf": {
    name: "Mobil Aero HF", grade: "", series: "Mobil Aero HF", type: "Havacılık Hidrolik Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Aero HF  kağıt makinelerinin zorlu çalışma şartlarında aşırı sıcak ortamlar ve değişik kalitede su ile temas etme durumlarına dayanması için özel olarak tasarlanmış üstün performans ürünlerimizdendir.Mobil Aero HF, sentetik bazyağlar ile yüksek kaliteli lityum kompleks kalınlaştırıcının özgün ",
    features: ["Mobil Aero HF"],
    image: "/images/products/mobil/aero-hf.jpg",
    fullDescription: `Mobil Aero HF  kağıt makinelerinin zorlu çalışma şartlarında aşırı sıcak ortamlar ve değişik kalitede su ile temas etme durumlarına dayanması için özel olarak tasarlanmış üstün performans ürünlerimizdendir.Mobil Aero HF, sentetik bazyağlar ile yüksek kaliteli lityum kompleks kalınlaştırıcının özgün özelliklerini bir araya getirmektedir. Sentetik bazyağlar mum (wax) içermeyen yapıları sayesinde aynı vizkositede sentetik olmayan diğer yağ ürünlerine kıyasla düşük sıcaklıkta mükemmel şekilde pompal`,
  },
  "aero-hfa": {
    name: "Mobil Aero HFA", grade: "", series: "Mobil Aero HFA", type: "Havacılık Hidrolik Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Aero   kağıt makinelerinin zorlu çalışma şartlarında aşırı sıcak ortamlar ve değişik kalitede su ile temas etme durumlarına dayanması için özel olarak tasarlanmış üstün performans ürünlerimizdendir. Mobil Oil Aero Red, sentetik bazyağlar ile yüksek kaliteli lityum kompleks kalınlaştırıcının öz",
    features: ["Mobil Aero HFA"],
    image: "/images/products/mobil/aero-hfa.jpg",
    fullDescription: `Mobil Aero   kağıt makinelerinin zorlu çalışma şartlarında aşırı sıcak ortamlar ve değişik kalitede su ile temas etme durumlarına dayanması için özel olarak tasarlanmış üstün performans ürünlerimizdendir. Mobil Oil Aero Red, sentetik bazyağlar ile yüksek kaliteli lityum kompleks kalınlaştırıcının özgün özelliklerini bir araya getirmektedir. Sentetik bazyağlar mum (wax) içermeyen yapıları sayesinde aynı vizkositede sentetik olmayan diğer yağ ürünlerine kıyasla düşük sıcaklıkta mükemmel şekilde po`,
  },
  "met-427": {
    name: "Mobil Met 427", grade: "ISO VG 427", series: "Mobil Met", type: "Metal İşleme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilmet 400 Serisi yüksek performanslı, çok amaçlı korozif olmayan ve su ile karıştırmadan kullanılan metal işleme yağlarıdır. Bu yağlar, hafif ve orta hizmet talaşlı imalat işlemleri için tasarlanmış olmakla birlikte aynı zamanda kesme yağı ve yağlama yağı arasındaki karşılıklı karışmanın neden ol",
    features: ["Mükemmel talaşlı imalat kapasitesi","Çok çeşitli malzeme ve operasyon ile uygunluk","Kızak ve tezgah fikstürleri üzerinde leke oluşturmaz","Açık renkli, saydam","Yağ sisi azdır","Daha güvenli ve konforlu bir çalışma ortamı sağlar"],
    image: "/images/products/mobil/met-427.jpg",
    fullDescription: `Mobilmet 400 Serisi yüksek performanslı, çok amaçlı korozif olmayan ve su ile karıştırmadan kullanılan metal işleme yağlarıdır. Bu yağlar, hafif ve orta hizmet talaşlı imalat işlemleri için tasarlanmış olmakla birlikte aynı zamanda kesme yağı ve yağlama yağı arasındaki karşılıklı karışmanın neden olabileceği problemleri önlediğinden takım tezgahları yağları ve hidrolik yağı olarak kullanılabilmektedir. Bu yağlar yüksek kaliteli baz yağlar ve çok geniş bir uygulama alanında etkili bir talaşlı ima`,
  },
  "dte-10-excel-15": {
    name: "Mobil DTE 10 Excel 15", grade: "ISO VG 15", series: "Mobil DTE 10 Excel", type: "Yüksek Performanslı Hidrolik Yağ",
    api: "DIN 51524 - 3 (HVLP, 2006 , pt. X X X X", acea: "DIN 51524 - 2 (HLP, 2006, pt. 2) X X X X X X",
    approvals: ["ISO 11158 HV X X X X","ISO 11158 HM X X X X X X","Denison HF-0 X X","Eaton Vickers I-286-S X X","Eaton Vickers 35VQ25 X X","Eaton Vickers M-2950-S X X","JCMAS HK-1 X","Bosch-Rexroth RE 90220-01 X X","Cincinnati Machine P70","Cincinnati Machine P69"],
    description: "Mobil Dte 10 Exel 15, özellikle modern, yüksek basınçlı, endüstriyel ve mobil ekipmanların hidrolik sistemlerin ihtiyaçlarını karşılamak üzere tasarlanmış yüksek performanslı, aşınma önleyici hidrolik yağlardır.",
    features: ["Mükemmel Hidrolik Verimlilik","Çok Üstün Temiz Tutma Performansı","Elastomer ve contalarla iyi bir uyumluluk Uzun conta ömrü ve daha az bakım","Aşınma önleyici özellikler","ve kavitasyon hasarını önlemeye yardım eder.","Mükemmel Hava Ayırma Özellikleri"],
    image: "/images/products/mobil/dte-10-excel-15.jpg",
    fullDescription: `Mobil Dte 10 Exel 15, özellikle modern, yüksek basınçlı, endüstriyel ve mobil ekipmanların hidrolik sistemlerin ihtiyaçlarını karşılamak üzere tasarlanmış yüksek performanslı, aşınma önleyici hidrolik yağlardır.`,
  },
  "pyrotec-hfc-46": {
    name: "Mobil Pyrotec HFC 46", grade: "ISO VG 46", series: "Mobil Pyrotec HFC", type: "Yangına Dayanıklı Hidrolik Sıvı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Pyrotec Hfc 46, özellikle modern, yüksek basınçlı, endüstriyel ve mobil ekipmanların hidrolik sistemlerin ihtiyaçlarını karşılamak üzere tasarlanmış yüksek performanslı, aşınma önleyici hidrolik yağlardır. Mobil Pyrotec Hfc 46, çeşitli uygulamalarda iyi dengelenmiş bir performans sağlamak amac",
    features: ["Mobil Pyrotec Hfc 46"],
    image: "/images/products/mobil/pyrotec-hfc-46.jpg",
    fullDescription: `Mobil Pyrotec Hfc 46, özellikle modern, yüksek basınçlı, endüstriyel ve mobil ekipmanların hidrolik sistemlerin ihtiyaçlarını karşılamak üzere tasarlanmış yüksek performanslı, aşınma önleyici hidrolik yağlardır. Mobil Pyrotec Hfc 46, çeşitli uygulamalarda iyi dengelenmiş bir performans sağlamak amacıyla seçilmiş baz yağlar ve katık sistemiyle oluşturulmuştur. Serideki ürünler, yüksek basınç ve yüksek debili pompaların kullanıldığı zorlu çalışma koşullarındaki hidrolik sistemlerde tortuyu en aza`,
  },
  "ect-44": {
    name: "Mobil ECT 44", grade: "ISO VG 44", series: "Mobil ECT", type: "Elektrik Transformatör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilect 44 trafo, şalt cihazları ve diğer elektrik donanımlar için tasarlanmış ve üstün dielektrik özellikler ve oksidasyon kararlılığına sahip yüksek kaliteli mineral izolasyon yağıdır. İzolasyon yağları korumalı ve korumasız olmak üzere iki sınıf altında temin edilebilir. Mobilect 44 korumalı sın",
    features: ["Mobilect 44'ün başlıca yararları şunlardır:"],
    image: "/images/products/mobil/ect-44.jpg",
    fullDescription: `Mobilect 44 trafo, şalt cihazları ve diğer elektrik donanımlar için tasarlanmış ve üstün dielektrik özellikler ve oksidasyon kararlılığına sahip yüksek kaliteli mineral izolasyon yağıdır. İzolasyon yağları korumalı ve korumasız olmak üzere iki sınıf altında temin edilebilir. Mobilect 44 korumalı sınıftır, daha üstün oksidasyon direnci sağlar ve IEC 60296 (82) Class IA ve IIA teknik özelliklerini karşılar.`,
  },
  "prosol-nt-70": {
    name: "Mobil Prosol NT 70", grade: "ISO VG 70", series: "Mobil Prosol NT", type: "Metal Temizleme Solüsyonu",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Prosol Nt 70, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/prosol-nt-70.jpg",
    fullDescription: `Mobil Prosol Nt 70, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Mobil Prosol Nt 70 yağları su ile kolayca ve kararlı mikro emülsiyonlarda`,
  },
  "cut-250": {
    name: "Mobil Cut 250", grade: "ISO VG 250", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 250 , suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yük",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/cut-250.jpg",
    fullDescription: `Mobilcut 250 , suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Mobilcut Esc  yağları su ile kolayca ve kararlı mikro emülsiyonlardan oluştura`,
  },
  "cut-240": {
    name: "Mobil Cut 240", grade: "ISO VG 240", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 240, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüks",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/cut-240.jpg",
    fullDescription: `Mobilcut 240, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Mobilcut 321 yağları su ile kolayca ve kararlı mikro emülsiyonlardan oluşturabi`,
  },
  "cut-230": {
    name: "Mobil Cut 230", grade: "ISO VG 230", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 200 Serisi, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdi",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/cut-230.jpg",
    fullDescription: `Mobilcut 200 Serisi, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Demir ve demir dışı metallerin , hafiften orta zorluktaki işlemlerine (M`,
  },
  "cut-210": {
    name: "Mobil Cut 210", grade: "ISO VG 210", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 200 Serisi, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdi",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/cut-210.jpg",
    fullDescription: `Mobilcut 200 Serisi, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Demir ve demir dışı metallerin , hafiften orta zorluktaki işlemlerine (M`,
  },
  "cut-140": {
    name: "Mobil Cut 140", grade: "ISO VG 140", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 100 yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü t",
    features: ["Kolay kontrol ve bakım      Tutarlı ve güvenilir performans sağlar","Klor ve Nitrit içermez      Atık yokme maliyetini düşürür ve çevreyi korur","Düşük seviyede koku      çalışma koşullarını iyileştirir."],
    image: "/images/products/mobil/cut-140.jpg",
    fullDescription: `Mobilcut 100 yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Demir ve demir dışı metallerin , hafiften orta zorluktaki işlemlerine (Mobilcut 222); ve orta düzeyden zor işlemlere (Mobilcut 232 ve 242) kadar uzanan`,
  },
  "cut-100": {
    name: "Mobil Cut 100", grade: "ISO VG 100", series: "Mobil Cut", type: "Kesme Sıvısı",
    api: "", acea: "",
    approvals: [],
    description: "Mobilcut 100, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüks",
    features: [],
    image: "/images/products/mobil/cut-100.jpg",
    fullDescription: `Mobilcut 100, suda çözünebilen, çok amaçlı, yüksek performanslı, yarı sentetik kesme yağlarıdır. Bu yağlar, çok çeşitli talaşlı imalat işlemlerinde yüksek işleme performansı göstererek çalışmasını sağlamak üzere yüksek kalitedeki baz yağları, emülgatörler ve katık sistemi formüle edilmişlerdir. Yüksek oranda yağ içeren emülsiyon, mükemmel kesme performansı, olağanüstü takım yağlaması ve korozyonu önleme görevi görür. Demir ve demir dışı metallerin , hafiften orta zorluktaki işlemlerine (Mobilcut`,
  },
  "exxon-hyjet-v": {
    name: "Exxon Hyjet V", grade: "", series: "Exxon Hyjet V", type: "Havacılık Hidrolik Sıvısı",
    api: "SAE Havacılık ve Uzay Standart AS1241C", acea: "",
    approvals: [],
    description: "Yangın Dayanıklı Fosfat Ester Havacılık Hidrolik Yağı",
    features: ["Özellikler","Avantajları ve Potansiyel Yararları","Daha uzun yağ ömrü.","Azaltılmış hidrolik sistem bakım maliyetleri","En düşük yoğunluk Tip IV sıvı","İndirimli uçak yakıt tüketimi, düşük işletme maliyetleri"],
    image: "/images/products/mobil/exxon-hyjet-v.jpg",
    fullDescription: `Yangın Dayanıklı Fosfat Ester Havacılık Hidrolik Yağı`,
  },
  "exxon-hyjet-iv-a-plus": {
    name: "Exxon Hyjet IV A Plus", grade: "", series: "Exxon Hyjet IV A Plus", type: "Havacılık Hidrolik Sıvısı",
    api: "SAE Havacılık ve Uzay Standart AS1241C", acea: "",
    approvals: [],
    description: "Yangın Dayanıklı Fosfat Ester Havacılık Hidrolik Yağı",
    features: ["Özellikler","Avantajları ve Potansiyel Yararları","Daha uzun yağ ömrü.","Azaltılmış hidrolik sistem bakım maliyetleri","En düşük yoğunluk Tip IV sıvı","İndirimli uçak yakıt tüketimi, düşük işletme maliyetleri"],
    image: "/images/products/mobil/exxon-hyjet-iv-a-plus.jpg",
    fullDescription: `Yangın Dayanıklı Fosfat Ester Havacılık Hidrolik Yağı`,
  },
  "jet-oil-254": {
    name: "Mobil Jet Oil 254", grade: "ISO VG 254", series: "Mobil Jet Oil", type: "Havacılık Türbin Yağı",
    api: "ABD Askeri Özellikler Mil-PRF-23699 Yüksek Termal Stabilite (HTS) karşı Onaylandı", acea: "",
    approvals: [],
    description: "Mobil Jet Petrol 254, üçüncü nesil, ekstra yüksek performans, ticari ve askeri uçaklarda kullanılan gaz türbin motorları için performans gereksinimlerini karşılamak için tasarlanmış sentetik uçak tipi gaz türbini yağıdır.   Bu ürün özel olarak hazırlanmış, engel-ester baz formüle edilmiş ve benzersi",
    features: ["Özellikleri","Avantajları ve Potansiyel Yararları","Tutar motor verimliliğini ve motor ömrünü uzatır","50 º C% 50 oranında artar ve mevduat kontrol azaltır dökme yağ oksidasyonu","Azaltır, motor bakım","Uygulamalar"],
    image: "/images/products/mobil/jet-oil-254.jpg",
    fullDescription: `Mobil Jet Petrol 254, üçüncü nesil, ekstra yüksek performans, ticari ve askeri uçaklarda kullanılan gaz türbin motorları için performans gereksinimlerini karşılamak için tasarlanmış sentetik uçak tipi gaz türbini yağıdır.   Bu ürün özel olarak hazırlanmış, engel-ester baz formüle edilmiş ve benzersiz bir kimyasal katkı paketi ile güçlendirilmiş.   Sonuç oluşturucu ve askeri özellikleri gerektirdiği fiziksel özelliklerini korurken bozulma ve tortu oluşumuna karşı dayanıklıdır Üstün ısıl ve oksida`,
  },
  "dte-746": {
    name: "Mobil DTE 746", grade: "ISO VG 746", series: "Mobil DTE", type: "Ağır Hizmet Dolaşım Yağı",
    api: "ASTM 4304 Type I ve III", acea: "DIN 51515 L-TD",
    approvals: ["DIN 51515 L-TG","ISO 8068 L-TGB (Kalite Düzeyi)","ISO 8068 L-TGSB (Kalite Düzeyi)"],
    description: "Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DT",
    features: ["Üstün oksidasyon, kimyasal ve renk kararlılığı","Üstün türbin sistemi güvenilirlik seviyesi ve azaltılmış arıza duruş süreleri","Mükemmel sudan ayrılabilirlik","Geliştirilmiş pas ve korozyon koruması","Hızlı hava bırakma ve köpük oluşumunu engelleme","Çinkosuz (Zinc Free)"],
    image: "/images/products/mobil/dte-746.jpg",
    fullDescription: `Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DTE 700 Serisi yağlar, antioksidanlar, pas ve korozyon inhibitörleri ve köpük önleyici maddelerini de içeren özenle seçilmiş olan bazyağlar ve katıklarla formüle edilmişlerdir. Bu bileşenler zaman içind`,
  },
  "dte-732": {
    name: "Mobil DTE 732", grade: "ISO VG 732", series: "Mobil DTE", type: "Ağır Hizmet Dolaşım Yağı",
    api: "ASTM 4304 Type I ve III", acea: "DIN 51515 L-TD",
    approvals: ["DIN 51515 L-TG","ISO 8068 L-TGB (Kalite Düzeyi)","ISO 8068 L-TGSB (Kalite Düzeyi)"],
    description: "Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DT",
    features: ["Üstün oksidasyon, kimyasal ve renk kararlılığı","Üstün türbin sistemi güvenilirlik seviyesi ve azaltılmış arıza duruş süreleri","Mükemmel sudan ayrılabilirlik","Geliştirilmiş pas ve korozyon koruması","Hızlı hava bırakma ve köpük oluşumunu engelleme","Çinkosuz (Zinc Free)"],
    image: "/images/products/mobil/dte-732.jpg",
    fullDescription: `Mobil DTE 700 Serisi yağlar uzun zamandır yüksek kalitesi ve güvenilirliğiyle tanınan Mobil DTE türbin yağlayıcı ürünler ailesinin en yeni üyesidir. Mobil DTE 700 Serisi, gaz ve buhar türbini uygulamalarında kullanılmak üzere özel olarak geliştirilmiş olan Çinko içermeyen türbin yağlarıdır. Mobil DTE 700 Serisi yağlar, antioksidanlar, pas ve korozyon inhibitörleri ve köpük önleyici maddelerini de içeren özenle seçilmiş olan bazyağlar ve katıklarla formüle edilmişlerdir. Bu bileşenler zaman içind`,
  },
  "gargoyle-arctic-shc-nh-68": {
    name: "Mobil Gargoyle Arctic SHC NH 68", grade: "ISO VG 68", series: "Mobil Gargoyle Arctic SHC NH", type: "Soğutma Kompresörü Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karş",
    features: ["Özellikleri Avantajları ve Sağlayabileceği Faydalar","az sayıda periyodik bakım sağlar","Mükemmel ısıl/oksidasyon ve kimyasal kararlılık","Düşük buharlaşma Viskozite artışını engeller, yağ tüketimini azaltır","Yüksek Viskozite indeksi ve wax içermeyen bileşim","Düşük çekme gerilim katsayısı"],
    image: "/images/products/mobil/gargoyle-arctic-shc-nh-68.jpg",
    fullDescription: `Bu Ürün Bülteninin içerdiği bilgiler geçerliliğini yitirmiştir. Mobil Gargoyle Arctic SHC 200 Serisi tam sentetik, soğutma kompresörleri ve ısı pompalarında kullanılmak üzere özel olarak tasarlanmış üstün performanslı yağlayıcılardır. Yağlayıcılar wax içermeyen, ısıl ve oksidasyon bozunmalarına karşı üstün dirence sahip sentetik hidrokarbon polialfaolefin (PAO) sıvılarından formüle edilmiştir. Doğal olarak sahip oldukları kesme dayanımlı yüksek viskozite indeksi ve düşük sıcaklıklardaki kolay ak`,
  },
  "rarus-829": {
    name: "Mobil Rarus 829", grade: "ISO VG 829", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Rarus 800 Serisi esas olarak ağır hizmet pistonlu hava kompresörlerinin yağlanmasında üstün performans sağlayan kompresör yağlarıdır. Bu yağlar, önde gelen kompresör imalatçı firmaları tarafından istenen en zor şartları karşılamak veya aşmak için tasarlanmıştır. Mineral esaslı ürünlerin istene",
    features: ["Yüksek performanslı sentetik esaslı yağlar","Güvenli kullanım sağlar","Supap performansı artar","Çıkış hatlarında daha az tortu oluşturur","Daha yüksek kompresör performansı sağlar","Daha uzun yağ ömrü sağlar"],
    image: "/images/products/mobil/rarus-829.jpg",
    fullDescription: `Mobil Rarus 800 Serisi esas olarak ağır hizmet pistonlu hava kompresörlerinin yağlanmasında üstün performans sağlayan kompresör yağlarıdır. Bu yağlar, önde gelen kompresör imalatçı firmaları tarafından istenen en zor şartları karşılamak veya aşmak için tasarlanmıştır. Mineral esaslı ürünlerin istenen gereksinimleri karşılamadığı koşullar altında çalışan kompresörlerin korunmasını ve güvenirliğini sağlayan özgün tasarımlı sentetik yağlar ve yüksek teknolojili katık sistemi ile formüle edilmiştir.`,
  },
  "rarus-827": {
    name: "Mobil Rarus 827", grade: "ISO VG 827", series: "Mobil Rarus", type: "Kompresör Yağı",
    api: "", acea: "",
    approvals: [],
    description: "Mobil Rarus 800 Serisi esas olarak ağır hizmet pistonlu hava kompresörlerinin yağlanmasında üstün performans sağlayan kompresör yağlarıdır. Bu yağlar, önde gelen kompresör imalatçı firmaları tarafından istenen en zor şartları karşılamak veya aşmak için tasarlanmıştır. Mineral esaslı ürünlerin istene",
    features: ["Yüksek performanslı sentetik esaslı yağlar","Güvenli kullanım sağlar","Supap performansı artar","Çıkış hatlarında daha az tortu oluşturur","Daha yüksek kompresör performansı sağlar","Daha uzun yağ ömrü sağlar"],
    image: "/images/products/mobil/rarus-827.jpg",
    fullDescription: `Mobil Rarus 800 Serisi esas olarak ağır hizmet pistonlu hava kompresörlerinin yağlanmasında üstün performans sağlayan kompresör yağlarıdır. Bu yağlar, önde gelen kompresör imalatçı firmaları tarafından istenen en zor şartları karşılamak veya aşmak için tasarlanmıştır. Mineral esaslı ürünlerin istenen gereksinimleri karşılamadığı koşullar altında çalışan kompresörlerin korunmasını ve güvenirliğini sağlayan özgün tasarımlı sentetik yağlar ve yüksek teknolojili katık sistemi ile formüle edilmiştir.`,
  },
};
...
const CASTROL_MOTOR_PRODUCTS: Record<string, ProductSpec> = {
  "edge-0w-20-ll-iv": {
    name: "Castrol EDGE 0W-20 LL IV",
    grade: "0W-20",
    series: "EDGE",
    type: "Tam Sentetik",
    api: "SP",
    acea: "C5/C6",
    approvals: ["BMW Longlife-17FE+", "MB-Approval 229.71/229.72", "Porsche C20", "VW 508 00/509 00", "Ford WSS-M2C956-A1"],
    description: "Liquid Titanium technology with ACEA C5/C6 and BMW Longlife-17FE+ approval for modern low-friction engines.",
    features: ["BMW Longlife-17FE+ approved", "VW 508/509 approved", "MB 229.71/229.72 approved", "Maximum fuel economy"],
    image: "/images/products/castrol/edge-0w-20-ll-iv.jpg",
  },
  "edge-0w-30-titanium-fst": {
    name: "Castrol Edge 0W-30 Titanium FST",
    grade: "0W-30",
    series: "EDGE",
    type: "Tam Sentetik",
    api: "SN",
    acea: "C3",
    approvals: ["BMW Longlife-04", "dexos2", "MB-Approval 229.31/229.51", "Renault RN 0700/RN 0710", "VW 502 00/505 00"],
    description: "Fully synthetic 0W-30 with Titanium FST technology for extended drain intervals and multi-OEM approval.",
    features: ["BMW Longlife-04 approved", "MB 229.51 approved", "dexos2 certified", "Extended drain intervals"],
    image: "/images/products/castrol/edge-0w-30-titanium-fst.jpg",
  },
  "edge-5w-30-fst-titanium-ll": {
    name: "Castrol Edge 5W-30 FST Titanium LL",
    grade: "5W-30",
    series: "EDGE",
    type: "Tam Sentetik",
    api: "SN/CF",
    acea: "C3",
    approvals: ["MB-Approval 229.31/229.51", "Porsche C30"],
    description: "High-performance fully synthetic 5W-30 with Titanium FST for petrol and diesel engines with DPF.",
    features: ["MB 229.51 approved", "Porsche C30 approved", "DPF compatible", "Low SAPS formulation"],
    image: "/images/products/castrol/edge-5w-30-fst-titanium-ll.jpg",
  },
  "edge-5w-30-c3": {
    ...
    api: "SN/CF",
    acea: "C3",
    approvals: ["MB-Approval 229.31/229.51", "Porsche C30", "BMW Longlife-04", "GM-dexos2", "Renault RN 0700/RN 0710", "VW 502.00/505.00/505.01"],
    description: "ACEA C3 fully synthetic 5W-30 with broad multi-OEM approval including BMW, MB, VW and Porsche.",
    features: ["ACEA C3 certified", "BMW Longlife-04 approved", "dexos2 certified", "VW 502/505 approved"],
    image: "/images/products/castrol/edge-5w-30-c3.jpg",
  },
  "edge-5w-30-m": {
    ...
    acea: "C3",
    approvals: ["MB-Approval 229.31/229.51", "Porsche C30", "BMW Longlife-04", "GM-dexos2", "Renault RN 0700/RN 0710", "VW 502.00/505.00/505.01"],
    description: "Fully synthetic 5W-30 with Titanium technology delivering superior friction reduction and engine protection.",
    features: ["35% stronger under extreme pressure", "ACEA C3 certified", "MB 229.51 approved", "VW 502/505 approved"],
    image: "/images/products/castrol/edge-5w-30-m.jpg",
  },
  "edge-5w-40-titanium-fst": {
    name: "Castrol Edge 5W-40 Titanium FST",
    grade: "5W-40",
    series: "EDGE",
    type: "Tam Sentetik",
    api: "SN/CF",
    acea: "A3/B4",
    approvals: ["BMW Longlife-04", "MB-Approval 229.31/229.51", "Porsche A40", "Renault RN0700/RN0710", "VW 502.00/505.00", "Fiat 9.55535-S2", "dexos2"],
    description: "Industry-leading fully synthetic 5W-40 with Titanium FST technology for maximum engine performance.",
    features: ["BMW Longlife-04 approved", "MB 229.51 approved", "Porsche A40 approved", "10% fuel economy gain vs conventional"],
    image: "/images/products/castrol/edge-5w-40-titanium-fst.jpg",
  },
  "edge-supercar-10w-60": {
    name: "Castrol Edge Supercar 10W-60",
    grade: "10W-60",
    series: "EDGE Supercar",
    type: "Tam Sentetik",
    api: "SN/CF",
    acea: "A3/B4",
    approvals: ["BMW M-Models", "VW 501.01/505.00"],
    description: "Premium fully synthetic 10W-60 engineered for supercars and high-performance sports vehicles.",
    features: ["BMW M-Models approved", "Superior high-temp protection", "ACEA A3/B4 certified", "Suitable for Ferrari, Bugatti, Aston Martin"],
    image: "/images/products/castrol/edge-supercar-10w-60.jpg",
  },
  "magnatec-stop-start-0w-20": {
    name: "Castrol Magnatec Stop-Start 0W-20",
    grade: "0W-20",
    series: "Magnatec",
    type: "Tam Sentetik",
    api: "SP",
    acea: "A1/B1",
    approvals: [],
    description: "Fully synthetic 0W-20 with intelligent molecules designed for stop-start city driving and superior warm-up protection.",
    features: ["Intelligent molecule technology", "Optimized for stop-start engines", "Superior cold-start protection", "Fuel economy focused"],
    image: "/images/products/castrol/magnatec-stop-start-0w-20.jpg",
  },
  "magnatec-a5-5w-30-start-stop": {
    name: "Castrol Magnatec A5 5W-30 Start Stop",
    grade: "5W-30",
    series: "Magnatec",
    type: "Yarı Sentetik",
    api: "SN",
    acea: "A5/B5",
    approvals: ["Ford WSS-M2C913-C", "Ford WSS-M2C913-D", "ILSAC GF-4"],
    description: "Semi-synthetic 5W-30 with self-renewing intelligent molecules for superior wear protection in stop-start traffic.",
    features: ["Ford WSS-M2C913-D approved", "ACEA A5/B5 fuel economy", "Stop-start optimized", "Up to 20% less wear"],
    image: "/images/products/castrol/magnatec-a5-5w-30-start-stop.jpg",
  },
  "magnatec-5w-30-a5": {
    ...
    acea: "A5/B5",
    approvals: ["Ford WSS-M2C913-C", "Ford WSS-M2C913-D", "ILSAC GF-4"],
    description: "Semi-synthetic 5W-30 with intelligent molecules providing superior protection during the critical warm-up phase.",
    features: ["Ford WSS-M2C913-D approved", "ACEA A5/B5 rated", "Stop-start protection", "Self-renewing molecules"],
    image: "/images/products/castrol/magnatec-5w-30-a5.jpg",
  },
  "magnatec-10w-40": {
    ...
    api: "SL/CF",
    acea: "A3/B4",
    approvals: ["MB-Approval 229.1", "Renault RN 0700/RN 0710", "VW 501.01/505.00", "Fiat 9.55535-D2"],
    description: "Semi-synthetic 10W-40 with intelligent molecules that cling to engine parts to reduce wear by up to 75% at startup.",
    features: ["MB 229.1 approved", "VW 501.01/505.00 approved", "75% less wear at startup", "Smart molecule technology"],
    image: "/images/products/castrol/magnatec-10w-40.jpg",
  },
  "gtx-5w-30-rn0720": {
    name: "Castrol GTX 5W-30 RN0720",
    grade: "5W-30",
    series: "GTX",
    type: "Mineral",
    api: "SL/CF",
    acea: "A3/B4",
    approvals: ["Renault RN 0720"],
    description: "Mineral 5W-30 formulated specifically for Renault vehicles with dual-action sludge protection.",
    features: ["Renault RN0720 approved", "Dual sludge protection", "Extended engine life", "Viscosity stability"],
    image: "/images/products/castrol/gtx-5w-30-rn0720.jpg",
  },
  "gtx-ultraclean-10w-40": {
    name: "Castrol GTX Ultraclean 10W-40",
    grade: "10W-40",
    series: "GTX Ultraclean",
    type: "Mineral",
    api: "SL/CF",
    acea: "A3/B4",
    approvals: [],
    description: "Mineral 10W-40 with 25% better sludge protection and 50% improved wear resistance versus industry standards.",
    features: ["25% better sludge protection", "50% better wear resistance", "ACEA A3/B4 certified", "Petrol and diesel compatible"],
    image: "/images/products/castrol/gtx-ultraclean-10w-40.jpg",
  },
  "gtx-lpg-20w-50": {
    name: "Castrol GTX LPG 20W-50",
    grade: "20W-50",
    series: "GTX LPG",
    type: "Mineral",
    api: "SL/CF",
    acea: "",
    approvals: [],
    description: "Mineral 20W-50 specially formulated for LPG-powered vehicles, compensating for the lower lubricity of LPG fuel.",
    features: ["LPG optimized formula", "50% more wear protection", "Maximum sludge protection", "Viscosity stability at high temp"],
    image: "/images/products/castrol/gtx-lpg-20w-50.jpg",
  },
  "gtx-20w-50": {
    ...
    acea: "",
    approvals: [],
    description: "Classic mineral 20W-50 providing reliable protection against wear and sludge in high-mileage engines.",
    features: ["50% more wear protection", "Maximum sludge defense", "High-temp viscosity stability", "Engine cooling and cleaning"],
    image: "/images/products/castrol/gtx-20w-50.jpg",
  },
  "multi-20w-50": {
    name: "Castrol Multi 20W-50",
    grade: "20W-50",
    series: "Multi",
    type: "Mineral",
    api: "CF-4/SF",
    acea: "",
    approvals: [],
    description: "Mineral diesel 20W-50 for heavy-duty diesel engines with 30% longer acid protection and four-season usability.",
    features: ["30% longer acid protection", "Prevents sludge and corrosion", "Soot thickening control", "Low oil consumption"],
    image: "/images/products/castrol/multi-20w-50.jpg",
  },
  "mini-truck-10w-30": {
    name: "Castrol Mini Truck 10W-30",
    grade: "10W-30",
    series: "Mini Truck",
    type: "Yarı Sentetik",
    api: "CH-4/CG-4",
    acea: "E3/E5",
    approvals: ["Ford WSS-M2C921-A"],
    description: "Semi-synthetic 10W-30 formulated for Ford Transit, Connect and light commercial vehicles with extended drain intervals.",
    features: ["Ford WSS-M2C921-A approved", "Extended drain intervals", "Superior engine cleanliness", "Rust and corrosion protection"],
    image: "/images/products/castrol/mini-truck-10w-30.jpg",
  },
  "vecton-fuel-saver-5w-30": {
    name: "Castrol Vecton Fuel Saver 5W-30",
    grade: "5W-30",
    series: "Vecton Fuel Saver",
    type: "Tam Sentetik",
    api: "CJ-4",
    acea: "E6/E9",
    approvals: ["MB-Approval 228.31/228.51", "MAN M 3477/M 3677", "Volvo VDS-4", "Deutz DQC IV-10LA", "Mack EO-M Plus"],
    description: "Fully synthetic heavy-duty diesel 5W-30 with System 5 Technology for Euro 6 engines and extended drain intervals.",
    features: ["Euro 6 compatible", "40% better performance in 5 critical areas", "Real-world fuel savings", "Extended drain intervals"],
    image: "/images/products/castrol/vecton-fuel-saver-5w-30.jpg",
  },
  "vecton-long-drain-10w-40": {
    name: "Castrol Vecton Long Drain 10W-40",
    grade: "10W-40",
    series: "Vecton Long Drain",
    type: "Tam Sentetik",
    api: "CI-4",
    acea: "E6/E7",
    approvals: ["MB-Approval 228.51", "MAN M 3477/M 3271-1", "Volvo VDS-3", "Deutz DQC IV-10LA", "Scania Low Ash", "RVI RLD-2"],
    description: "Fully synthetic 10W-40 with System 5 Technology providing 40% higher performance for extended drain Euro 4/5 diesels.",
    features: ["System 5 Technology", "MB 228.51 approved", "Volvo VDS-3 approved", "Extended drain intervals"],
    image: "/images/products/castrol/vecton-long-drain-10w-40.jpg",
  },
  "vecton-10w-40": {
    name: "Castrol Vecton 10W-40",
    grade: "10W-40",
    series: "Vecton",
    type: "Mineral",
    api: "CI-4",
    acea: "E4/E7",
    approvals: [],
    description: "Heavy-duty diesel 10W-40 with System 5 Technology for commercial trucks with improved fuel economy and wear protection.",
    features: ["ACEA E4/E7 certified", "System 5 Technology", "Fuel economy improvement", "Extended drain capability"],
    image: "/images/products/castrol/vecton-10w-40.jpg",
  },
  "enduron-plus-5w-30": {
    name: "Castrol Enduron Plus 5W-30",
    grade: "5W-30",
    series: "Enduron",
    type: "Tam Sentetik",
    api: "CF",
    acea: "E4/E5/E7",
    approvals: ["MB-Approval 228.5", "MAN M 3277", "Volvo VDS-3", "Scania LDF", "DAF HP-1/HP-2", "Cummins CES 20077", "Mack EO-M Plus"],
    description: "Fully synthetic SHPD diesel 5W-30 for all diesel engines, delivering high fuel efficiency and long drain capability.",
    features: ["MB 228.5 approved", "Volvo VDS-3 approved", "MAN M3277 approved", "SHPD full synthetic"],
    image: "/images/products/castrol/enduron-plus-5w-30.jpg",
  },
  "elixion-low-saps-5w-30": {
    name: "Castrol Elixion Low SAPS 5W-30",
    grade: "5W-30",
    series: "Elixion",
    type: "Tam Sentetik",
    api: "CF",
    acea: "E4/E6/E7",
    approvals: ["MB-Approval 228.51", "MAN M3277/M3477", "Volvo VDS-3", "RVI RXD/RLD-2", "DAF long drain"],
    description: "Fully synthetic low SAPS heavy-duty diesel 5W-30 for Euro 4 fleets with the longest drain intervals.",
    features: ["Low SAPS formula", "MB 228.51 approved", "Euro 4 optimized", "Biodiesel compatible"],
    image: "/images/products/castrol/elixion-low-saps-5w-30.jpg",
  },
  "crb-turbomax-10w-40": {
    name: "Castrol CRB Turbomax 10W-40",
    grade: "10W-40",
    series: "CRB Turbomax",
    type: "Mineral",
    api: "CI-4",
    acea: "",
    approvals: [],
    description: "Mineral diesel 10W-40 with Durashield Technology actively fighting wear, soot and corrosion in harsh conditions.",
    features: ["Durashield Technology", "Soot and deposit removal", "Protective film formation", "Acid neutralization"],
    image: "/images/products/castrol/crb-turbomax-10w-40.jpg",
  },
  "turbomax-10w-40-ci4": {
    name: "Castrol Turbomax 10W-40 CI4",
    grade: "10W-40",
    series: "Turbomax",
    type: "Mineral",
    api: "CI-4",
    acea: "",
    approvals: [],
    description: "Mineral diesel 10W-40 with Durashield Technology for diesel engines in varying weather and load conditions.",
    features: ["Durashield Technology", "Soot particle removal", "Heat resistance", "Anti-corrosion protection"],
    image: "/images/products/castrol/turbomax-10w-40-ci4.jpg",
  },
  "crb-turbomax-15w-40": {
    ...
    api: "CI-4",
    acea: "",
    approvals: ["MB-Approval", "MAN", "Volvo"],
    description: "Mineral diesel 15W-40 with Durashield Technology delivering up to twice the engine life versus standard oils.",
    features: ["Durashield Technology", "Twice the engine life", "MB/MAN/Volvo approved", "Biodiesel compatible"],
    image: "/images/products/castrol/crb-turbomax-15w-40.jpg",
  },
  "crb-multi-20w-50": {
    name: "Castrol CRB Multi 20W-50",
    grade: "20W-50",
    series: "CRB Multi",
    type: "Mineral",
    api: "CF-4/SF",
    acea: "",
    approvals: [],
    description: "Multipurpose mineral diesel 20W-50 for older high-mileage diesel fleets with stable oil pressure and low consumption.",
    features: ["Foam prevention", "Stable oil pressure", "Deposit prevention", "Startup wear protection"],
    image: "/images/products/castrol/crb-multi-20w-50.jpg",
  },
  "tection-monograde-10w": {
    name: "Castrol Tection Monograde 10W",
    grade: "10W",
    series: "Tection",
    type: "Mineral",
    api: "CF",
    acea: "E1",
    approvals: ["CAT TO-2", "MB-Approval 228.0"],
    description: "Single-grade mineral diesel 10W for heavy-duty diesel engines and construction machinery transmissions and hydraulics.",
    features: ["API CF certified", "ACEA E1 rated", "MB 228.0 approved", "CAT TO-2 certified"],
    image: "/images/products/castrol/tection-monograde-10w.jpg",
  },
  "tection-monograde-30w": {
    name: "Castrol Tection Monograde 30W",
    grade: "30W",
    series: "Tection",
    type: "Mineral",
    api: "CF",
    acea: "E1",
    approvals: ["CAT TO-2", "MB-Approval 228.0"],
    description: "Single-grade mineral diesel 30W for heavy-duty diesel engines and construction/industrial machinery systems.",
    features: ["API CF certified", "ACEA E1 rated", "MB 228.0 approved", "No extreme-pressure additives"],
    image: "/images/products/castrol/tection-monograde-30w.jpg",
  },
  "tection-f-tr-10w-30": {
    name: "Castrol Tection F-TR 10W-30",
    grade: "10W-30",
    series: "Tection",
    type: "Yarı Sentetik",
    api: "CH-4/CG-4",
    acea: "E3/E5",
    approvals: ["Ford WSS-M2C921-A"],
    description: "Semi-synthetic diesel 10W-30 formulated for Ford Transit and Connect vehicles with extended drain intervals.",
    features: ["Ford WSS-M2C921-A approved", "Extended drain intervals", "Cold-start fluidity", "Rust and corrosion protection"],
    image: "/images/products/castrol/tection-f-tr-10w-30.jpg",
  },
};
