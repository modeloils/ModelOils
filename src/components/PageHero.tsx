...
export function PageHero({
  ...
  return (
    ...
    >
      ...
      {!transparent && <div className="brand-hero-glow pointer-events-none absolute inset-0" />}
      <div className={`relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ${paddingClass}`}>
        <span className="brand-eyebrow inline-flex items-center justify-center gap-2 text-xs font-semibold uppercase tracking-[0.2em]">
