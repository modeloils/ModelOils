...
const CATEGORY_DATA: Record<string, CategoryData> = {
  ...
  Antifrizler: {
    ...
    details: {
      "Antifriz-37": {
        ...
        standards: "ASTM D3306, D3564, D6210, SAE J 1034, TS 3582, BS 6580",
      ...
      "Antifriz-56": {
        ...
        standards: "ASTM D3306, D3564, SAE J 1034, TS 3582, BS 6580, G-11",
        packaging: ["3 L", "20 L", "200 L"],
      },
      "Antifriz-Konsantre": {
        description: {
  ...
  Gresler: {
    ...
    products: [
      ...
      {
        slug: "CAL-221",
        name: "CAL-221 Kalsiyum Bazlı Gres",
        displayName: {
          en: "CAL-221 Calcium Based Grease",
          tr: "CAL-221 Kalsiyum Bazlı Gres",
          ru: "Кальциевая смазка CAL-221",
          fa: "گریس پایه کلسیم CAL-221",
          ar: "شحم CAL-221 القائم على الكالسيوم",
          de: "CAL-221 Kalziumbasiertes Fett",
          fr: "Graisse CAL-221 à base de calcium",
        },
        image: "/model-oils/images/hi-tech/gresler/CAL-221.jpeg",
      },
      {
        ...
        image: "/model-oils/images/hi-tech/gresler/Ball-Valve-Grease-2026.jpeg",
      },
      {
        slug: "Lithmax-EP-3",
        ...
        image: "/model-oils/images/hi-tech/gresler/Lithmax-EP-3-2026.jpeg",
      },
      {
        slug: "Calsol",
        ...
        image: "/model-oils/images/hi-tech/gresler/Calsol-2026.jpeg",
      },
    ],
    details: {
      "Gres-Beyaz": {
      ...
      "CAL-221": {
        description: {
          tr: "HI-TECH CAL-221, yüksek sıcaklık ve ağır yük koşulları için geliştirilmiş NLGI 2 kalsiyum bazlı, ısıya dayanıklı EP grestir. Güçlü mekanik kararlılığı, suyla yıkanmaya direnci, yüksek yapışması ve korozyon koruması sayesinde rulmanlar, şasi, endüstriyel makineler, inşaat, madencilik, tarım ve denizcilik ekipmanlarında uzun servis ömrü sağlar.",
          en: "HI-TECH CAL-221 is an NLGI 2 calcium-based, heat-resistant EP grease developed for high-temperature and heavy-load conditions. Its outstanding mechanical stability, water-washout resistance, strong adhesion and corrosion protection provide long service life in wheel bearings, chassis, industrial machinery, construction, mining, agricultural and marine equipment.",
          ru: "HI-TECH CAL-221 — термостойкая кальциевая EP-смазка класса NLGI 2 для высоких температур и тяжёлых нагрузок. Высокая механическая стабильность, стойкость к вымыванию водой, прочное сцепление и защита от коррозии обеспечивают длительный срок службы подшипников, шасси, промышленной, строительной, горнодобывающей, сельскохозяйственной и морской техники.",
          fa: "HI-TECH CAL-221 گریس EP مقاوم در برابر حرارت، بر پایه کلسیم و با گرید NLGI 2 است که برای دماهای بالا و بارهای سنگین توسعه یافته است. پایداری مکانیکی عالی، مقاومت در برابر شست‌وشو با آب، چسبندگی قوی و حفاظت در برابر خوردگی، عمر سرویس طولانی را در بلبرینگ چرخ، شاسی، ماشین‌آلات صنعتی، ساختمانی، معدنی، کشاورزی و دریایی فراهم می‌کند.",
          ar: "HI-TECH CAL-221 شحم EP مقاوم للحرارة قائم على الكالسيوم بدرجة NLGI 2، مطوّر لدرجات الحرارة العالية والأحمال الثقيلة. يوفر ثباتاً ميكانيكياً ممتازاً ومقاومة للغسل بالماء والتصاقاً قوياً وحماية من التآكل لعمر خدمة طويل في محامل العجلات والهيكل والآلات الصناعية ومعدات البناء والتعدين والزراعة والبحرية.",
          de: "HI-TECH CAL-221 ist ein hitzebeständiges EP-Fett der Klasse NLGI 2 auf Kalziumbasis für hohe Temperaturen und schwere Lasten. Hervorragende mechanische Stabilität, Auswaschbeständigkeit, starke Haftung und Korrosionsschutz sorgen für lange Lebensdauer in Radlagern, Fahrwerken sowie Industrie-, Bau-, Bergbau-, Landwirtschafts- und Marinegeräten.",
          fr: "HI-TECH CAL-221 est une graisse EP résistante à la chaleur, à base de calcium et de grade NLGI 2, développée pour les températures élevées et les fortes charges. Son excellente stabilité mécanique, sa résistance au délavage, sa forte adhérence et sa protection anticorrosion assurent une longue durée de service des roulements, châssis et équipements industriels, de construction, miniers, agricoles et marins.",
        },
        features: {
          tr: [
            "Ağır yüklerde mükemmel EP performansı, yüksek mekanik kararlılık ve güvenilir yük taşıma kapasitesi sunar.",
            "Su ile yıkanmaya, oksidasyona, pasa ve korozyona karşı üstün direnç sağlar.",
            "-60°C ile +150°C arasında güçlü yapışma, sızdırmazlık ve uzun servis ömrü sunar.",
          ],
          en: [
            "Delivers excellent EP performance, outstanding mechanical stability and reliable load-carrying capacity.",
            "Provides superior resistance to water washout, oxidation, rust and corrosion.",
            "Offers strong adhesion, sealing performance and long service life from -60°C to +150°C.",
          ],
          ru: [
            "Обеспечивает отличные EP-характеристики, высокую механическую стабильность и надёжную несущую способность.",
            "Обладает высокой стойкостью к вымыванию водой, окислению, ржавчине и коррозии.",
            "Обеспечивает прочное сцепление, уплотнение и длительный срок службы от -60°C до +150°C.",
          ],
          fa: [
            "عملکرد عالی EP، پایداری مکانیکی برجسته و ظرفیت تحمل بار قابل اعتماد ارائه می‌دهد.",
            "مقاومت برتر در برابر شست‌وشو با آب، اکسیداسیون، زنگ‌زدگی و خوردگی فراهم می‌کند.",
            "از ۶۰- تا ۱۵۰+ درجه سانتیگراد چسبندگی قوی، آب‌بندی و عمر سرویس طولانی ارائه می‌دهد.",
          ],
          ar: [
            "يوفر أداء EP ممتازاً وثباتاً ميكانيكياً عالياً وقدرة موثوقة على تحمل الأحمال.",
            "يوفر مقاومة فائقة للغسل بالماء والأكسدة والصدأ والتآكل.",
            "يوفر التصاقاً قوياً وإحكاماً وعمر خدمة طويلاً من -60°C إلى +150°C.",
          ],
          de: [
            "Bietet ausgezeichnete EP-Leistung, hohe mechanische Stabilität und zuverlässige Lasttragefähigkeit.",
            "Bietet hervorragenden Schutz gegen Wasserauswaschung, Oxidation, Rost und Korrosion.",
            "Starke Haftung, Dichtwirkung und lange Lebensdauer von -60°C bis +150°C.",
          ],
          fr: [
            "Offre d'excellentes performances EP, une grande stabilité mécanique et une capacité de charge fiable.",
            "Assure une résistance supérieure au délavage, à l'oxydation, à la rouille et à la corrosion.",
            "Offre une forte adhérence, une bonne étanchéité et une longue durée de service de -60°C à +150°C.",
          ],
        },
        standards: {
          tr: "NLGI 2 • Kalsiyum bazlı • -60°C ile +150°C",
          en: "NLGI 2 • Calcium based • -60°C to +150°C",
          ru: "NLGI 2 • Кальциевая основа • от -60°C до +150°C",
          fa: "NLGI 2 • پایه کلسیم • ۶۰- تا ۱۵۰+ درجه سانتیگراد",
          ar: "NLGI 2 • قائم على الكالسيوم • من -60°C إلى +150°C",
          de: "NLGI 2 • Kalziumbasiert • -60°C bis +150°C",
          fr: "NLGI 2 • À base de calcium • -60°C à +150°C",
        },
        packaging: ["14 KG", "180 KG"],
      },
      "Ball-Valve-Grease": {
        description: {
          tr: "HI-TECH KÜRESEL VANA GRESİ, küresel vana uygulamalarında yağlama ve sızdırmazlık için geliştirilmiş sentetik Li-Zn kalınlaştırıcılı NLGI 4 özel grestir. Suya ve kimyasallara karşı üstün direnç, güçlü yapışma ve güvenilir kaçak önleme sunar. Küresel, plug, sürgülü ve endüstriyel vanalar ile açık deniz, denizcilik, kimya ve petrokimya tesislerine uygundur.",
          en: "HI-TECH BALL VALVE GREASE is an NLGI 4 specialty grease with a synthetic Li-Zn thickener, developed to lubricate and seal ball valve applications. It offers superior water and chemical resistance, strong adhesion and reliable leak prevention. Suitable for ball, plug, gate and industrial valves, as well as offshore, marine, chemical and petrochemical facilities.",
          ru: "HI-TECH BALL VALVE GREASE — специальная смазка класса NLGI 4 с синтетическим загустителем Li-Zn для смазывания и герметизации шаровых кранов. Обеспечивает высокую стойкость к воде и химикатам, прочное сцепление и надёжное предотвращение утечек. Подходит для шаровых, пробковых, задвижных и промышленных клапанов, а также морских, химических и нефтехимических объектов.",
          fa: "HI-TECH BALL VALVE GREASE گریس تخصصی NLGI 4 با غلیظ‌کننده سنتتیک Li-Zn است که برای روانکاری و آب‌بندی شیرهای توپی توسعه یافته است. مقاومت برتر در برابر آب و مواد شیمیایی، چسبندگی قوی و جلوگیری مطمئن از نشتی ارائه می‌دهد و برای شیرهای توپی، سماوری، کشویی و صنعتی و کاربردهای فراساحلی، دریایی، شیمیایی و پتروشیمی مناسب است.",
          ar: "HI-TECH BALL VALVE GREASE شحم متخصص بدرجة NLGI 4 مع مثخن صناعي Li-Zn، مطوّر لتشحيم وإحكام الصمامات الكروية. يوفر مقاومة فائقة للماء والمواد الكيميائية والتصاقاً قوياً ومنعاً موثوقاً للتسرب. مناسب للصمامات الكروية والسدادية والبوابية والصناعية والمنشآت البحرية والكيميائية والبتروكيميائية.",
          de: "HI-TECH BALL VALVE GREASE ist ein Spezialfett der Klasse NLGI 4 mit synthetischem Li-Zn-Verdicker zur Schmierung und Abdichtung von Kugelhähnen. Es bietet hervorragende Wasser- und Chemikalienbeständigkeit, starke Haftung und zuverlässige Leckagevermeidung. Geeignet für Kugel-, Küken-, Schieber- und Industrieventile sowie Offshore-, Marine-, Chemie- und Petrochemieanlagen.",
          fr: "HI-TECH BALL VALVE GREASE est une graisse spéciale de grade NLGI 4 avec épaississant synthétique Li-Zn, développée pour lubrifier et étanchéifier les vannes à boisseau sphérique. Elle offre une excellente résistance à l'eau et aux produits chimiques, une forte adhérence et une prévention fiable des fuites. Convient aux vannes industrielles et aux installations offshore, marines, chimiques et pétrochimiques.",
        },
        features: {
          tr: [
            ...
            "-40°C ile +130°C arasında güçlü yapışma ve yüksek yük taşıma kapasitesini korur.",
          ],
          en: [
            ...
            "Maintains strong adhesion and high load-carrying capacity from -40°C to +130°C.",
          ],
          ru: [
            ...
            "Сохраняет прочное сцепление и высокую несущую способность при температурах от -40°C до +130°C.",
          ],
          fa: [
            ...
            "در محدوده دمایی ۴۰- تا ۱۳۰+ درجه سانتیگراد چسبندگی قوی و ظرفیت تحمل بار بالا را حفظ می‌کند.",
          ],
          ar: [
            ...
            "يحافظ على التصاق قوي وقدرة عالية على تحمل الأحمال من -40°C إلى +130°C.",
          ],
          de: [
            ...
            "Behält starke Haftung und hohe Lasttragefähigkeit von -40°C bis +130°C bei.",
          ],
          fr: [
            ...
            "Conserve une forte adhérence et une capacité de charge élevée de -40°C à +130°C.",
          ],
        },
        standards: {
          tr: "NLGI 4 • Sentetik Li-Zn • -40°C ile +130°C",
          en: "NLGI 4 • Synthetic Li-Zn • -40°C to +130°C",
          ru: "NLGI 4 • Синтетический Li-Zn • от -40°C до +130°C",
          fa: "NLGI 4 • سنتتیک Li-Zn • ۴۰- تا ۱۳۰+ درجه سانتیگراد",
          ar: "NLGI 4 • صناعي Li-Zn • من -40°C إلى +130°C",
          de: "NLGI 4 • Synthetisches Li-Zn • -40°C bis +130°C",
          fr: "NLGI 4 • Li-Zn synthétique • -40°C à +130°C",
        },
        packaging: ["14 KG", "180 KG"],
      },
      "Lithmax-EP-3": {
        ...
        features: {
          tr: [
            ...
            "-40°C ile +120°C arasında rulmanlar, şasi ve genel amaçlı uygulamalar için güvenilir yağlama sağlar.",
          ],
          en: [
            ...
            "Provides reliable lubrication for bearings, chassis and general-purpose applications from -40°C to +120°C.",
          ],
          ru: [
            ...
            "Обеспечивает надёжную смазку подшипников, шасси и узлов общего назначения при температурах от -40°C до +120°C.",
          ],
          fa: [
            ...
            "از ۴۰- تا ۱۲۰+ درجه سانتیگراد برای بلبرینگ‌ها، شاسی و کاربردهای عمومی روانکاری قابل اعتماد فراهم می‌کند.",
          ],
          ar: [
            "يوفر أداء EP ممتازاً وثباتاً ميكانيكياً عالياً تحت الأحمال الثقيلة.",
            "يقاوم الماء والأكسدة والتحلل الحراري والصدأ والتآكل.",
            "يوفر تشحيماً موثوقاً للمحامل والهيكل والتطبيقات العامة من -40°C إلى +120°C.",
          ],
          de: [
            ...
            "Zuverlässige Schmierung für Lager, Fahrwerk und allgemeine Anwendungen von -40°C bis +120°C.",
          ],
          fr: [
            ...
            "Assure une lubrification fiable des roulements, châssis et applications générales de -40°C à +120°C.",
          ],
        },
        standards: {
          tr: "NLGI 3 • Lityum • -40°C ile +120°C",
          en: "NLGI 3 • Lithium • -40°C to +120°C",
          ru: "NLGI 3 • Литий • от -40°C до +120°C",
          fa: "NLGI 3 • لیتیم • ۴۰- تا ۱۲۰+ درجه سانتیگراد",
          ar: "NLGI 3 • ليثيوم • من -40°C إلى +120°C",
          de: "NLGI 3 • Lithium • -40°C bis +120°C",
          fr: "NLGI 3 • Lithium • -40°C à +120°C",
        },
        packaging: ["14 KG", "180 KG"],
      },
      "Lithmax-Complex": {
      ...
      Calsol: {
        ...
        features: {
          tr: [
            ...
            "-30°C ile +65°C arasında otomotiv, endüstri, inşaat ve tarım ekipmanlarında kullanıma uygundur.",
          ],
          en: [
            ...
            "Suitable for automotive, industrial, construction and agricultural equipment from -30°C to +65°C.",
          ],
          ru: [
            ...
            "Подходит для автомобильной, промышленной, строительной и сельскохозяйственной техники при температурах от -30°C до +65°C.",
          ],
          fa: [
            ...
            "از ۳۰- تا ۶۵+ درجه سانتیگراد برای تجهیزات خودرویی، صنعتی، ساختمانی و کشاورزی مناسب است.",
          ],
          ar: [
            ...
            "مناسب لمعدات السيارات والصناعة والبناء والزراعة من -30°C إلى +65°C.",
          ],
          de: [
            ...
            "Geeignet für Automobil-, Industrie-, Bau- und Landwirtschaftsgeräte von -30°C bis +65°C.",
          ],
          fr: [
            ...
            "Convient aux équipements automobiles, industriels, de construction et agricoles de -30°C à +65°C.",
          ],
        },
        standards: {
          tr: "NLGI 2 • Kalsiyum sabun (Solidol) • -30°C ile +65°C",
          en: "NLGI 2 • Calcium soap (Solidol) • -30°C to +65°C",
          ru: "NLGI 2 • Кальциевое мыло (Солидол) • от -30°C до +65°C",
          fa: "NLGI 2 • صابون کلسیم (Solidol) • ۳۰- تا ۶۵+ درجه سانتیگراد",
          ar: "NLGI 2 • صابون الكالسيوم (Solidol) • من -30°C إلى +65°C",
          de: "NLGI 2 • Kalziumseife (Solidol) • -30°C bis +65°C",
          fr: "NLGI 2 • Savon de calcium (Solidol) • -30°C à +65°C",
        },
        packaging: ["14 KG", "180 KG"],
      },
    },
  ...
  "Endustriyel-Yaglar": {
    ...
    products: [
      { slug: "Hydra-32",  name: "Hydra 32 Hidrolik Yağ", displayName: { en: "Hydra 32 Hydraulic Oil", tr: "Hydra 32 Hidrolik Yağ", ru: "Hydra 32 Гидравлическое масло", fa: "روغن هیدرولیک Hydra 32", ar: "زيت هيدروليكي Hydra 32", de: "Hydra 32 Hydrauliköl", fr: "Huile hydraulique Hydra 32" }, image: "/model-oils/images/hi-tech/endustriyel/Hydra32.png" },
      ...
      { slug: "Hydra-Pro-15", name: "Hydra Pro 15 Hidrolik Yağ", displayName: { en: "Hydra Pro 15 Hydraulic Oil", tr: "Hydra Pro 15 Hidrolik Yağ", ru: "Hydra Pro 15 Гидравлическое масло", fa: "روغن هیدرولیک Hydra Pro 15", ar: "زيت هيدروليكي Hydra Pro 15", de: "Hydra Pro 15 Hydrauliköl", fr: "Huile hydraulique Hydra Pro 15" }, image: "/model-oils/images/hi-tech/endustriyel/Hydra-Pro-15.jpeg" },
      { slug: "Heat-Transfer-Oil-S2", name: "Isı Transfer Yağı S2", displayName: { en: "Heat Transfer Oil S2", tr: "Isı Transfer Yağı S2", ru: "Теплоноситель S2", fa: "روغن انتقال حرارت S2", ar: "زيت نقل الحرارة S2", de: "Wärmeträgeröl S2", fr: "Huile caloporteuse S2" }, image: "/model-oils/images/hi-tech/endustriyel/Heat-Transfer-Oil-S2.jpeg" },
    ],
    details: {
      "Hydra-32": {
        description: {
      ...
      "Transol-HV-1500": {
        ...
        features: {
          ...
          tr: ["Güvenilir yalıtım için mükemmel dielektrik dayanım.", "Üstün oksidasyon ve termal stabilite tortu oluşumunu azaltır.", "Düşük sıcaklık performansı ve korozyon koruması ekipman ömrünü uzatır."],
          ru: ["Высокая диэлектрическая прочность обеспечивает надёжную изоляцию.", "Стойкость к окислению и нагреву снижает образование шлама.", "Низкотемпературные свойства и защита от коррозии продлевают ресурс оборудования."],
          fa: ["استحکام دی‌الکتریک عالی، عایق‌کاری مطمئن را فراهم می‌کند.", "پایداری اکسیداسیون و حرارتی، تشکیل لجن و رسوب را کاهش می‌دهد.", "عملکرد دمای پایین و حفاظت خوردگی عمر تجهیزات را افزایش می‌دهد."],
          ar: ["قوة عزل كهربائي ممتازة لضمان عزل موثوق.", "ثبات فائق ضد الأكسدة والحرارة يقلل الحمأة والرواسب.", "أداء جيد في الحرارة المنخفضة وحماية من التآكل لإطالة عمر المعدات."],
          de: ["Hohe Durchschlagsfestigkeit sorgt für zuverlässige Isolierung.", "Oxidations- und Temperaturstabilität minimieren Schlamm und Ablagerungen.", "Tieftemperaturleistung und Korrosionsschutz verlängern die Gerätelebensdauer."],
      ...
      "Airmax-S-46": {
        description: {
          en: "HI-TECH AIRMAX S 46 is an ISO VG 46 air-compressor oil developed for reliable industrial performance and long service life.",
          tr: "HI-TECH AIRMAX S 46, güvenilir endüstriyel performans ve uzun servis ömrü için geliştirilmiş ISO VG 46 hava kompresörü yağıdır.",
          ru: "HI-TECH AIRMAX S 46 — компрессорное масло ISO VG 46 для надёжной промышленной работы и длительного срока службы.",
          fa: "HI-TECH AIRMAX S 46 روغن کمپرسور هوا با گرید ISO VG 46 برای عملکرد صنعتی مطمئن و عمر طولانی است.",
          ar: "HI-TECH AIRMAX S 46 زيت ضاغط هواء بدرجة ISO VG 46 لأداء صناعي موثوق وعمر خدمة طويل.",
          de: "HI-TECH AIRMAX S 46 ist ein Luftkompressorenöl der Klasse ISO VG 46 für zuverlässige Industrieleistung und lange Standzeit.",
          fr: "HI-TECH AIRMAX S 46 est une huile pour compresseurs d'air ISO VG 46 conçue pour des performances industrielles fiables et une longue durée de service.",
        },
        features: {
          en: ["Excellent thermal stability under demanding operation.", "Superior anti-wear protection safeguards compressor components.", "Long service life supports dependable industrial use."],
          tr: ["Zorlu çalışmada mükemmel termal stabilite.", "Üstün aşınma koruması kompresör bileşenlerini korur.", "Uzun servis ömrü güvenilir endüstriyel kullanımı destekler."],
          ru: ["Отличная термостабильность в тяжёлых условиях.", "Противоизносная защита сохраняет детали компрессора.", "Длительный срок службы обеспечивает надёжную эксплуатацию."],
          fa: ["پایداری حرارتی عالی در کار سنگین.", "حفاظت برتر ضد سایش از اجزای کمپرسور محافظت می‌کند.", "عمر طولانی، کارکرد صنعتی مطمئن را پشتیبانی می‌کند."],
          ar: ["ثبات حراري ممتاز في ظروف التشغيل الصعبة.", "حماية فائقة من التآكل لمكونات الضاغط.", "عمر خدمة طويل لأداء صناعي موثوق."],
          de: ["Ausgezeichnete thermische Stabilität bei anspruchsvollem Betrieb.", "Überlegener Verschleißschutz schützt Kompressorkomponenten.", "Lange Standzeit unterstützt zuverlässigen Industrieeinsatz."],
      ...
      "Progen-S": {
        description: {
          en: "HI-TECH PROGEN S is a premium diesel engine oil for diesel engines used in compressors and generators.",
          tr: "HI-TECH PROGEN S, kompresör ve jeneratörlerde kullanılan dizel motorlar için premium dizel motor yağıdır.",
          ru: "HI-TECH PROGEN S — премиальное дизельное моторное масло для двигателей компрессоров и генераторов.",
          fa: "HI-TECH PROGEN S روغن موتور دیزل ممتاز برای موتورهای دیزلی کمپرسورها و ژنراتورها است.",
          ar: "HI-TECH PROGEN S زيت محرك ديزل ممتاز للمحركات المستخدمة في الضواغط والمولدات.",
          de: "HI-TECH PROGEN S ist ein Premium-Dieselmotoröl für Dieselmotoren in Kompressoren und Generatoren.",
          fr: "HI-TECH PROGEN S est une huile moteur diesel premium pour les moteurs de compresseurs et de groupes électrogènes.",
        },
        features: {
          en: ["Excellent wear protection and engine cleanliness.", "Oxidation and thermal stability resist severe operating conditions.", "Fuel efficiency plus rust and corrosion protection support long engine life."],
          tr: ["Mükemmel aşınma koruması ve motor temizliği.", "Oksidasyon ve termal stabilite ağır çalışma koşullarına direnir.", "Yakıt verimliliği ile pas ve korozyon koruması uzun motor ömrünü destekler."],
          ru: ["Высокая защита от износа и чистота двигателя.", "Стойкость к окислению и нагреву в тяжёлых условиях.", "Топливная экономичность и защита от коррозии продлевают ресурс двигателя."],
          fa: ["حفاظت عالی از سایش و پاکیزگی موتور.", "پایداری اکسیداسیون و حرارتی در شرایط سخت.", "بهره‌وری سوخت و حفاظت خوردگی عمر موتور را افزایش می‌دهد."],
          ar: ["حماية ممتازة من التآكل ونظافة للمحرك.", "ثبات ضد الأكسدة والحرارة في الظروف القاسية.", "كفاءة الوقود والحماية من الصدأ والتآكل تدعمان عمر المحرك."],
          de: ["Ausgezeichneter Verschleißschutz und hohe Motorsauberkeit.", "Oxidations- und Temperaturstabilität unter schweren Bedingungen.", "Kraftstoffeffizienz und Korrosionsschutz unterstützen eine lange Motorlebensdauer."],
      ...
      "Hydra-Pro-46": {
        description: {
          en: "HI-TECH HYDRA PRO 46 is a premium ISO VG 46 hydraulic oil for hydraulic systems, construction equipment, industrial machinery, forklifts and agricultural equipment.",
          tr: "HI-TECH HYDRA PRO 46; hidrolik sistemler, iş makineleri, endüstriyel makineler, forkliftler ve tarım ekipmanları için premium ISO VG 46 hidrolik yağıdır.",
          ru: "HI-TECH HYDRA PRO 46 — премиальное гидравлическое масло ISO VG 46 для гидросистем, строительной и промышленной техники, погрузчиков и сельхозоборудования.",
          fa: "HI-TECH HYDRA PRO 46 روغن هیدرولیک ممتاز ISO VG 46 برای سامانه‌های هیدرولیک، ماشین‌آلات ساختمانی و صنعتی، لیفتراک و تجهیزات کشاورزی است.",
          ar: "HI-TECH HYDRA PRO 46 زيت هيدروليكي ممتاز ISO VG 46 للأنظمة الهيدروليكية ومعدات البناء والآلات الصناعية والرافعات الشوكية والمعدات الزراعية.",
          de: "HI-TECH HYDRA PRO 46 ist ein Premium-Hydrauliköl ISO VG 46 für Hydrauliksysteme, Bau- und Industriemaschinen, Gabelstapler und Landtechnik.",
          fr: "HI-TECH HYDRA PRO 46 est une huile hydraulique premium ISO VG 46 pour systèmes hydrauliques, engins de chantier, machines industrielles, chariots élévateurs et équipements agricoles.",
        },
        features: {
          en: ["Excellent anti-wear protection extends component life.", "Oxidation and thermal stability resist sludge and high temperatures.", "Rust protection and excellent filterability keep systems clean."],
          tr: ["Mükemmel aşınma koruması bileşen ömrünü uzatır.", "Oksidasyon ve termal stabilite tortu ile yüksek sıcaklığa direnir.", "Pas koruması ve mükemmel filtrelenebilirlik sistemi temiz tutar."],
          ru: ["Высокая противоизносная защита продлевает ресурс деталей.", "Стойкость к окислению и нагреву препятствует отложениям.", "Защита от ржавчины и фильтруемость поддерживают чистоту системы."],
          fa: ["حفاظت عالی ضد سایش عمر اجزا را افزایش می‌دهد.", "پایداری حرارتی و اکسیداسیون در برابر رسوب مقاومت می‌کند.", "حفاظت زنگ‌زدگی و فیلترپذیری عالی سامانه را پاک نگه می‌دارد."],
          ar: ["حماية ممتازة من التآكل تطيل عمر المكونات.", "ثبات الأكسدة والحرارة يقاوم الرواسب ودرجات الحرارة العالية.", "الحماية من الصدأ وقابلية الترشيح تحافظان على نظافة النظام."],
          de: ["Ausgezeichneter Verschleißschutz verlängert die Komponentenlebensdauer.", "Oxidations- und Temperaturstabilität widerstehen Schlamm und Hitze.", "Rostschutz und Filtrierbarkeit halten das System sauber."],
      ...
      "Hydra-Pro-15": {
        description: {
          en: "HI-TECH HYDRA PRO 15 is a premium ISO VG 15 hydraulic oil for hydraulic systems, construction equipment, industrial machinery, forklifts and agricultural equipment.",
          tr: "HI-TECH HYDRA PRO 15; hidrolik sistemler, iş makineleri, endüstriyel makineler, forkliftler ve tarım ekipmanları için premium ISO VG 15 hidrolik yağıdır.",
          ru: "HI-TECH HYDRA PRO 15 — премиальное гидравлическое масло ISO VG 15 для гидросистем, строительной и промышленной техники, погрузчиков и сельхозоборудования.",
          fa: "HI-TECH HYDRA PRO 15 روغن هیدرولیک ممتاز ISO VG 15 برای سامانه‌های هیدرولیک، ماشین‌آلات ساختمانی و صنعتی، لیفتراک و تجهیزات کشاورزی است.",
          ar: "HI-TECH HYDRA PRO 15 زيت هيدروليكي ممتاز ISO VG 15 للأنظمة الهيدروليكية ومعدات البناء والآلات الصناعية والرافعات الشوكية والمعدات الزراعية.",
          de: "HI-TECH HYDRA PRO 15 ist ein Premium-Hydrauliköl ISO VG 15 für Hydrauliksysteme, Bau- und Industriemaschinen, Gabelstapler und Landtechnik.",
          fr: "HI-TECH HYDRA PRO 15 est une huile hydraulique premium ISO VG 15 pour systèmes hydrauliques, engins de chantier, machines industrielles, chariots élévateurs et équipements agricoles.",
        },
        features: {
          en: ["Excellent anti-wear protection extends component life.", "Oxidation and thermal stability resist sludge and high temperatures.", "Rust protection and excellent filterability keep systems clean."],
          tr: ["Mükemmel aşınma koruması bileşen ömrünü uzatır.", "Oksidasyon ve termal stabilite tortu ile yüksek sıcaklığa direnir.", "Pas koruması ve mükemmel filtrelenebilirlik sistemi temiz tutar."],
      ...
      "Heat-Transfer-Oil-S2": {
        description: {
          en: "HI-TECH HEAT TRANSFER OIL S2 is a heat-transfer fluid for closed systems in industrial heating, chemical plants, oil and gas and textile applications.",
          tr: "HI-TECH ISI TRANSFER YAĞI S2; endüstriyel ısıtma, kimya tesisleri, petrol-gaz ve tekstil uygulamalarındaki kapalı sistemler için ısı transfer akışkanıdır.",
          ru: "HI-TECH HEAT TRANSFER OIL S2 — теплоноситель для закрытых систем промышленного нагрева, химических производств, нефтегазовой и текстильной отраслей.",
          fa: "HI-TECH HEAT TRANSFER OIL S2 سیال انتقال حرارت برای سامانه‌های بسته گرمایش صنعتی، صنایع شیمیایی، نفت و گاز و نساجی است.",
          ar: "HI-TECH HEAT TRANSFER OIL S2 سائل نقل حرارة للأنظمة المغلقة في التدفئة الصناعية والمصانع الكيميائية والنفط والغاز وصناعة النسيج.",
          de: "HI-TECH HEAT TRANSFER OIL S2 ist eine Wärmeträgerflüssigkeit für geschlossene Systeme in Industrieheizung, Chemieanlagen, Öl und Gas sowie Textilindustrie.",
          fr: "HI-TECH HEAT TRANSFER OIL S2 est un fluide caloporteur pour circuits fermés de chauffage industriel, usines chimiques, pétrole et gaz et industrie textile.",
        },
        features: {
          en: ["Excellent thermal efficiency for effective heat transfer.", "Thermal and oxidation stability support long fluid life.", "Low vapour pressure, corrosion protection and sealed-system compatibility."],
          tr: ["Etkili ısı transferi için mükemmel termal verimlilik.", "Termal ve oksidasyon stabilitesi uzun akışkan ömrü sağlar.", "Düşük buhar basıncı, korozyon koruması ve kapalı sistem uyumu."],
          ru: ["Высокая тепловая эффективность для эффективной теплопередачи.", "Термоокислительная стабильность обеспечивает долгий срок службы.", "Низкое давление паров, защита от коррозии и совместимость с закрытыми системами."],
          fa: ["بازده حرارتی عالی برای انتقال مؤثر گرما.", "پایداری حرارتی و اکسیداسیون عمر طولانی سیال را فراهم می‌کند.", "فشار بخار پایین، حفاظت خوردگی و سازگاری با سامانه بسته."],
          ar: ["كفاءة حرارية ممتازة لنقل الحرارة بفعالية.", "الثبات الحراري وثبات الأكسدة يدعمان عمر السائل.", "ضغط بخار منخفض وحماية من التآكل وتوافق مع الأنظمة المغلقة."],
          de: ["Ausgezeichnete thermische Effizienz für wirksame Wärmeübertragung.", "Temperatur- und Oxidationsstabilität ermöglichen lange Flüssigkeitslebensdauer.", "Niedriger Dampfdruck, Korrosionsschutz und Eignung für geschlossene Systeme."],
  ...
  "Agir-Hizmet-Motor-Yaglari": {
    ...
    details: {
      "HD-5W30": {
        ...
        standards: "API CK-4, ACEA E6/E11, Volvo VDS-4.5, MB 228.51, Caterpillar ECF-3, Cummins CES 20081, MAN M3677, Mack EO-O Premium Plus, Renault VI RXD",
        packaging: ["20 L", "200 L"],
      },
      "HD-10W40": {
        description: {
        ...
        standards: "API CI-4, ACEA E4/E7/E9, Volvo VDS-3, MB 228.3, Caterpillar ECF-2, Cummins CES 20076, MAN M3275, Mack EO-N, Renault VI RLD",
        packaging: ["20 L", "200 L"],
      },
      "HD-15W40": {
        description: {
        ...
        standards: "API CI-4, ACEA C7, MB 228.3, MAN M3275, Caterpillar ECF-2, Cummins CES 20076, Volvo VDS-3, Mack EO-N, Renault RLD",
        packaging: ["20 L", "200 L"],
      },
      "SAE-30W": {
        description: {
  ...
  "Motosiklet-Yaglari": {
    ...
    products: [
      { slug: "Moto-4T-10W40", name: "4T 10W-40 Motosiklet Yağı", displayName: { en: "4T 10W-40 Motorcycle Oil", tr: "4T 10W-40 Motosiklet Yağı", ru: "4T 10W-40 Масло для мотоцикла", fa: "روغن موتورسیکلت 4T 10W-40", ar: "زيت دراجات نارية 4T 10W-40", de: "4T 10W-40 Motorradöl", fr: "Huile moto 4T 10W-40" }, image: "/model-oils/images/hi-tech/motosiklet/4t-10w40.jpeg" },
      { slug: "Moto-4T-5W40", name: "4T 5W-40 Motosiklet Yağı", displayName: { en: "4T 5W-40 Motorcycle Oil", tr: "4T 5W-40 Motosiklet Yağı", ru: "4T 5W-40 Масло для мотоцикла", fa: "روغن موتورسیکلت 4T 5W-40", ar: "زيت دراجات نارية 4T 5W-40", de: "4T 5W-40 Motorradöl", fr: "Huile moto 4T 5W-40" }, image: "/model-oils/images/hi-tech/motosiklet/4t-5w40.jpeg" },
      { slug: "Moto-2T", name: "2T Motosiklet Yağı", displayName: { en: "2T Motorcycle Oil", tr: "2T Motosiklet Yağı", ru: "2T Масло для мотоцикла", fa: "روغن موتورسیکلت 2T", ar: "زيت دراجات نارية 2T", de: "2T Motorradöl", fr: "Huile moto 2T" }, image: "/model-oils/images/hi-tech/motosiklet/2t-new.jpeg" },
      { slug: "Moto-4T-15W50", name: "4T 15W-50 Motosiklet Yağı", displayName: { en: "4T 15W-50 Motorcycle Oil", tr: "4T 15W-50 Motosiklet Yağı", ru: "4T 15W-50 Масло для мотоцикла", fa: "روغن موتورسیکلت 4T 15W-50", ar: "زيت دراجات نارية 4T 15W-50", de: "4T 15W-50 Motorradöl", fr: "Huile moto 4T 15W-50" }, image: "/model-oils/images/hi-tech/motosiklet/4t-15w50.jpeg" },
    ],
    details: {
      "Moto-4T-10W40": {
        description: {
        ...
        features: {
          tr: [
            "Aşınma ve tortulara karşı mükemmel motor koruması.",
            "Yüksek sıcaklık performansı için üstün termal kararlılık.",
            "Yumuşak hızlanma ve sessiz çalışma.",
            "Motor dayanıklılığı için optimum yağlama.",
          ],
          en: [
            "Excellent engine protection against wear and deposits.",
            "Superior thermal stability for high-temperature performance.",
            "Smooth acceleration and quiet performance.",
            "Optimal lubrication for engine durability.",
          ],
          ru: [
            "Отличная защита двигателя от износа и отложений.",
            "Высокая термостабильность при повышенных температурах.",
            "Плавное ускорение и тихая работа.",
            "Оптимальная смазка для долговечности двигателя.",
          ],
          fa: [
            "حفاظت عالی موتور در برابر سایش و رسوبات.",
            "پایداری حرارتی برتر در دمای بالا.",
            "شتاب‌گیری روان و عملکرد کم‌صدا.",
            "روانکاری بهینه برای دوام موتور.",
          ],
          ar: [
            "حماية ممتازة للمحرك من التآكل والرواسب.",
            "ثبات حراري فائق للأداء في درجات الحرارة العالية.",
            "تسارع سلس وتشغيل هادئ.",
            "تزييت مثالي لمتانة المحرك.",
          ],
          de: [
            "Ausgezeichneter Motorschutz vor Verschleiß und Ablagerungen.",
            "Überlegene thermische Stabilität bei hohen Temperaturen.",
            "Sanfte Beschleunigung und ruhiger Lauf.",
            "Optimale Schmierung für lange Motorlebensdauer.",
          ],
          fr: [
            "Excellente protection du moteur contre l'usure et les dépôts.",
            "Stabilité thermique supérieure à haute température.",
            "Accélération fluide et fonctionnement silencieux.",
            "Lubrification optimale pour la longévité du moteur.",
          ],
        },
        standards: "API SN / SM / SL, JASO MA2, ACEA A3/B4, ISO 9001:2015",
        packaging: ["1 L", "200 L"],
      },
      "Moto-4T-5W40": {
        description: {
          tr: "HI-TECH 4T 5W-40, 4 zamanlı motosiklet ve scooterlar için geliştirilmiş üstün performanslı motor yağıdır. Hızlı soğuk çalışma koruması, yüksek sıcaklıkta termal kararlılık ve JASO MA2 uyumu ile motor ve ıslak debriyaj sisteminde güvenilir performans sağlar.",
          en: "HI-TECH 4T 5W-40 is an ultimate-performance engine oil developed for four-stroke motorcycles and scooters. It provides rapid cold-start protection, superior high-temperature stability and reliable engine and wet-clutch performance through JASO MA2 compliance.",
          ru: "HI-TECH 4T 5W-40 — высокоэффективное моторное масло для четырёхтактных мотоциклов и скутеров. Обеспечивает быструю защиту при холодном пуске, термостабильность и надёжную работу двигателя и мокрого сцепления по JASO MA2.",
          fa: "HI-TECH 4T 5W-40 روغن موتور با عملکرد برتر برای موتورسیکلت‌ها و اسکوترهای چهارزمانه است. حفاظت سریع در استارت سرد، پایداری حرارتی عالی و عملکرد مطمئن موتور و کلاچ تر مطابق JASO MA2 را فراهم می‌کند.",
          ar: "HI-TECH 4T 5W-40 زيت محرك فائق الأداء للدراجات النارية والسكوترات رباعية الأشواط. يوفر حماية سريعة عند التشغيل البارد وثباتاً حرارياً ممتازاً وأداءً موثوقاً للمحرك والقابض المبلل وفق JASO MA2.",
          de: "HI-TECH 4T 5W-40 ist ein Hochleistungs-Motoröl für Viertakt-Motorräder und -Roller. Es bietet schnellen Kaltstartschutz, hohe Temperaturstabilität und zuverlässige Motor- und Nasskupplungsleistung gemäß JASO MA2.",
          fr: "HI-TECH 4T 5W-40 est une huile moteur très haute performance pour motos et scooters quatre temps. Elle assure une protection rapide à froid, une excellente stabilité thermique et un fonctionnement fiable du moteur et de l'embrayage humide conforme JASO MA2.",
        },
        features: {
          tr: ["Aşınma ve tortulara karşı mükemmel motor koruması.", "Yüksek sıcaklık performansı için üstün termal kararlılık.", "Yumuşak hızlanma ve sessiz çalışma.", "Motor dayanıklılığı için optimum yağlama."],
          en: ["Excellent engine protection against wear and deposits.", "Superior thermal stability for high-temperature performance.", "Smooth acceleration and quiet performance.", "Optimal lubrication for engine durability."],
          ru: ["Отличная защита двигателя от износа и отложений.", "Высокая термостабильность при повышенных температурах.", "Плавное ускорение и тихая работа.", "Оптимальная смазка для долговечности двигателя."],
          fa: ["حفاظت عالی موتور در برابر سایش و رسوبات.", "پایداری حرارتی برتر در دمای بالا.", "شتاب‌گیری روان و عملکرد کم‌صدا.", "روانکاری بهینه برای دوام موتور."],
          ar: ["حماية ممتازة للمحرك من التآكل والرواسب.", "ثبات حراري فائق للأداء في درجات الحرارة العالية.", "تسارع سلس وتشغيل هادئ.", "تزييت مثالي لمتانة المحرك."],
          de: ["Ausgezeichneter Motorschutz vor Verschleiß und Ablagerungen.", "Überlegene thermische Stabilität bei hohen Temperaturen.", "Sanfte Beschleunigung und ruhiger Lauf.", "Optimale Schmierung für lange Motorlebensdauer."],
          fr: ["Excellente protection du moteur contre l'usure et les dépôts.", "Stabilité thermique supérieure à haute température.", "Accélération fluide et fonctionnement silencieux.", "Lubrification optimale pour la longévité du moteur."],
        },
        standards: "API SN / SM / SL, JASO MA2, ACEA A3/B4, ISO 9001:2015",
        packaging: ["1 L", "200 L"],
      },
      "Moto-2T": {
        ...
        standards: "API TC, JASO FB, ISO-L-EGB, TISI 1040",
        packaging: ["1 L", "200 L"],
      },
      "Moto-4T-15W50": {
        description: {
          tr: "HI-TECH 4T 15W-50, 4 zamanlı motosiklet ve scooterlar için geliştirilmiş yüksek performanslı motor yağıdır. Yüksek sıcaklık ve ağır kullanım koşullarında güçlü yağ filmi, üstün motor koruması ve JASO MA2 uyumlu ıslak debriyaj performansı sunar.",
          en: "HI-TECH 4T 15W-50 is a high-performance engine oil developed for four-stroke motorcycles and scooters. It delivers a strong oil film, excellent engine protection and JASO MA2 compatible wet-clutch performance under high temperatures and demanding use.",
          ru: "HI-TECH 4T 15W-50 — высокоэффективное масло для четырёхтактных мотоциклов и скутеров. Прочная масляная плёнка, защита двигателя и совместимость с мокрым сцеплением JASO MA2 сохраняются при высокой температуре и тяжёлой эксплуатации.",
          fa: "HI-TECH 4T 15W-50 روغن موتور پرفورمنس بالا برای موتورسیکلت‌ها و اسکوترهای چهارزمانه است. در دمای بالا و کار سنگین، فیلم روغن قوی، حفاظت عالی موتور و عملکرد کلاچ تر مطابق JASO MA2 را فراهم می‌کند.",
          ar: "HI-TECH 4T 15W-50 زيت محرك عالي الأداء للدراجات النارية والسكوترات رباعية الأشواط. يوفر طبقة زيت قوية وحماية ممتازة للمحرك وأداء قابض مبلل متوافقاً مع JASO MA2 في الحرارة العالية والاستخدام الشاق.",
          de: "HI-TECH 4T 15W-50 ist ein Hochleistungs-Motoröl für Viertakt-Motorräder und -Roller. Bei hohen Temperaturen und anspruchsvollem Einsatz bietet es einen starken Ölfilm, ausgezeichneten Motorschutz und JASO-MA2-konforme Nasskupplungsleistung.",
          fr: "HI-TECH 4T 15W-50 est une huile haute performance pour motos et scooters quatre temps. Elle fournit un film d'huile robuste, une excellente protection moteur et des performances d'embrayage humide conformes JASO MA2 à haute température et en service sévère.",
        },
        features: {
          tr: ["Aşınma ve tortulara karşı mükemmel motor koruması.", "Yüksek sıcaklık performansı için üstün termal kararlılık.", "Yumuşak hızlanma ve sessiz çalışma.", "Motor dayanıklılığı için optimum yağlama."],
          en: ["Excellent engine protection against wear and deposits.", "Superior thermal stability for high-temperature performance.", "Smooth acceleration and quiet performance.", "Optimal lubrication for engine durability."],
  ...
  "Disli-ve-Transmisyon-Yaglari": {
    ...
    products: [
      ...
      { slug: "Gear-80W90",  name: "80W-90 Sentetik Dişli Yağı",  displayName: { en: "80W-90 Synthetic Gear Oil", tr: "80W-90 Sentetik Dişli Yağı", ru: "80W-90 Синтетическое трансмиссионное масло", fa: "روغن دنده سنتتیک 80W-90", ar: "زيت تروس اصطناعي 80W-90", de: "80W-90 Synthetisches Getriebeöl", fr: "Huile de transmission synthétique 80W-90" }, image: "/model-oils/images/hi-tech/disliler/8090.png" },
      { slug: "Gear-85W140", name: "85W-140 Sentetik Dişli Yağı", displayName: { en: "85W-140 Synthetic Gear Oil", tr: "85W-140 Sentetik Dişli Yağı", ru: "85W-140 Синтетическое трансмиссионное масло", fa: "روغن دنده سنتتیک 85W-140", ar: "زيت تروس اصطناعي 85W-140", de: "85W-140 Synthetisches Getriebeöl", fr: "Huile de transmission synthétique 85W-140" }, image: "/model-oils/images/hi-tech/disliler/85140.png" },
      { slug: "Gear-90W",    name: "Gear 90W Mineral Dişli Yağı", displayName: { en: "Gear 90W Mineral Gear Oil", tr: "Gear 90W Mineral Dişli Yağı", ru: "Gear 90W Минеральное трансмиссионное масло", fa: "روغن دنده معدنی Gear 90W", ar: "زيت تروس معدني Gear 90W", de: "Gear 90W Mineralisches Getriebeöl", fr: "Huile de transmission minérale Gear 90W" }, image: "/model-oils/images/hi-tech/disliler/90w.png" },
      { slug: "Gear-140",    name: "Gear 140 Mineral Dişli Yağı", displayName: { en: "Gear 140 Mineral Gear Oil", tr: "Gear 140 Mineral Dişli Yağı", ru: "Gear 140 Минеральное трансмиссионное масло", fa: "روغن دنده معدنی Gear 140", ar: "زيت تروس معدني Gear 140", de: "Gear 140 Mineralisches Getriebeöl", fr: "Huile de transmission minérale Gear 140" }, image: "/model-oils/images/hi-tech/disliler/140w.png" },
      { slug: "Gearmax-150", name: "Gearmax 150 Dişli Yağı", displayName: { en: "Gearmax 150 Gear Oil", tr: "Gearmax 150 Dişli Yağı", ru: "Gearmax 150 Редукторное масло", fa: "روغن دنده Gearmax 150", ar: "زيت تروس Gearmax 150", de: "Gearmax 150 Getriebeöl", fr: "Huile pour engrenages Gearmax 150" }, image: "/model-oils/images/hi-tech/disliler/Gearmax-150.jpeg" },
    ...
    details: {
      ...
      "Gearmax-150": {
        description: {
          en: "HI-TECH GEARMAX 150 is a premium industrial gear oil for gearboxes and heavy-duty equipment used in mining, construction and steel-mill applications.",
          tr: "HI-TECH GEARMAX 150; madencilik, inşaat ve çelik endüstrisindeki dişli kutuları ile ağır hizmet ekipmanları için premium endüstriyel dişli yağıdır.",
          ru: "HI-TECH GEARMAX 150 — премиальное индустриальное редукторное масло для редукторов и тяжёлого оборудования в горнодобывающей, строительной и сталелитейной отраслях.",
          fa: "HI-TECH GEARMAX 150 روغن دنده صنعتی ممتاز برای گیربکس‌ها و تجهیزات سنگین در معدن، ساخت‌وساز و صنایع فولاد است.",
          ar: "HI-TECH GEARMAX 150 زيت تروس صناعي ممتاز لعلب التروس والمعدات الثقيلة في التعدين والبناء وصناعة الصلب.",
          de: "HI-TECH GEARMAX 150 ist ein Premium-Industriegetriebeöl für Getriebe und Schwerlastgeräte in Bergbau, Bauwesen und Stahlwerken.",
          fr: "HI-TECH GEARMAX 150 est une huile premium pour engrenages industriels et équipements lourds des secteurs minier, de la construction et de la sidérurgie.",
        },
        features: {
          en: ["Excellent wear protection and load-carrying capacity extend gear life.", "Thermal and oxidation stability resist breakdown at high temperatures.", "Rust and corrosion protection supports smooth, quiet operation."],
          tr: ["Mükemmel aşınma koruması ve yük taşıma kapasitesi dişli ömrünü uzatır.", "Termal ve oksidasyon stabilitesi yüksek sıcaklıkta bozulmaya direnir.", "Pas ve korozyon koruması sessiz ve düzgün çalışmayı destekler."],
          ru: ["Защита от износа и высокая несущая способность продлевают ресурс передач.", "Термоокислительная стабильность препятствует разрушению при нагреве.", "Защита от коррозии обеспечивает плавную и тихую работу."],
          fa: ["حفاظت عالی ضد سایش و ظرفیت باربری عمر دنده را افزایش می‌دهد.", "پایداری حرارتی و اکسیداسیون در دمای بالا مقاومت می‌کند.", "حفاظت زنگ و خوردگی عملکرد روان و کم‌صدا را پشتیبانی می‌کند."],
          ar: ["حماية ممتازة من التآكل وقدرة حمل عالية تطيل عمر التروس.", "ثبات حراري وضد الأكسدة يقاوم التحلل في الحرارة العالية.", "الحماية من الصدأ والتآكل تدعم التشغيل السلس والهادئ."],
          de: ["Verschleißschutz und hohe Lasttragefähigkeit verlängern die Lebensdauer.", "Temperatur- und Oxidationsstabilität widerstehen Abbau bei Hitze.", "Rost- und Korrosionsschutz unterstützen ruhigen, gleichmäßigen Betrieb."],
      ...
      "Gearmax-320": {
        description: {
          en: "HI-TECH GEARMAX 320 is a high-performance industrial gear oil for gearboxes and heavy-duty equipment used in mining, construction and steel-mill applications.",
          tr: "HI-TECH GEARMAX 320; madencilik, inşaat ve çelik endüstrisindeki dişli kutuları ile ağır hizmet ekipmanları için yüksek performanslı endüstriyel dişli yağıdır.",
          ru: "HI-TECH GEARMAX 320 — высокоэффективное индустриальное редукторное масло для редукторов и тяжёлого оборудования в горнодобывающей, строительной и сталелитейной отраслях.",
          fa: "HI-TECH GEARMAX 320 روغن دنده صنعتی پرفورمنس بالا برای گیربکس‌ها و تجهیزات سنگین در معدن، ساخت‌وساز و صنایع فولاد است.",
          ar: "HI-TECH GEARMAX 320 زيت تروس صناعي عالي الأداء لعلب التروس والمعدات الثقيلة في التعدين والبناء وصناعة الصلب.",
          de: "HI-TECH GEARMAX 320 ist ein Hochleistungs-Industriegetriebeöl für Getriebe und Schwerlastgeräte in Bergbau, Bauwesen und Stahlwerken.",
          fr: "HI-TECH GEARMAX 320 est une huile haute performance pour engrenages industriels et équipements lourds des secteurs minier, de la construction et de la sidérurgie.",
        },
        features: {
          en: ["Excellent load-carrying capacity protects under high pressure.", "Outstanding wear protection extends gear and bearing life.", "Thermal stability, corrosion protection and smooth operation support reliable performance."],
          tr: ["Mükemmel yük taşıma kapasitesi yüksek basınç altında korur.", "Üstün aşınma koruması dişli ve rulman ömrünü uzatır.", "Termal stabilite, korozyon koruması ve düzgün çalışma güvenilir performans sağlar."],
          ru: ["Высокая несущая способность защищает при высоком давлении.", "Противоизносная защита продлевает ресурс шестерён и подшипников.", "Термостабильность и защита от коррозии обеспечивают надёжную работу."],
          fa: ["ظرفیت باربری عالی در فشار بالا محافظت می‌کند.", "حفاظت برتر ضد سایش عمر دنده و یاتاقان را افزایش می‌دهد.", "پایداری حرارتی و حفاظت خوردگی عملکرد مطمئن را فراهم می‌کند."],
          ar: ["قدرة حمل ممتازة توفر الحماية تحت الضغط العالي.", "حماية فائقة من التآكل تطيل عمر التروس والمحامل.", "الثبات الحراري والحماية من التآكل يدعمان الأداء الموثوق."],
          de: ["Hohe Lasttragefähigkeit schützt unter hohem Druck.", "Verschleißschutz verlängert Zahnrad- und Lagerlebensdauer.", "Temperaturstabilität und Korrosionsschutz sichern zuverlässigen Betrieb."],
      ...
      "Power-Steering-Fluid": {
        description: {
          en: "HI-TECH POWER STEERING FLUID is a premium fluid for power-steering systems in passenger cars, commercial vehicles, SUVs and 4x4 vehicles. It supports smooth, precise steering while protecting the system in all conditions.",
          tr: "HI-TECH HİDROLİK DİREKSİYON YAĞI; binek otomobiller, ticari araçlar, SUV ve 4x4 araçların hidrolik direksiyon sistemleri için premium bir sıvıdır. Her koşulda sistemi korurken yumuşak ve hassas direksiyon kontrolü sağlar.",
          ru: "HI-TECH POWER STEERING FLUID — премиальная жидкость для гидроусилителей легковых, коммерческих автомобилей, SUV и 4x4. Обеспечивает плавное и точное управление и защищает систему во всех условиях.",
          fa: "HI-TECH POWER STEERING FLUID سیال ممتاز فرمان هیدرولیک برای خودروهای سواری، تجاری، شاسی‌بلند و 4x4 است و کنترل روان و دقیق را همراه با حفاظت سامانه فراهم می‌کند.",
          ar: "HI-TECH POWER STEERING FLUID سائل ممتاز لأنظمة التوجيه المعزز في سيارات الركاب والمركبات التجارية وSUV و4x4، ويوفر توجيهاً سلساً ودقيقاً مع حماية النظام.",
          de: "HI-TECH POWER STEERING FLUID ist eine Premiumflüssigkeit für Servolenkungen in Pkw, Nutzfahrzeugen, SUVs und 4x4-Fahrzeugen. Sie ermöglicht eine sanfte, präzise Lenkung und schützt das System.",
          fr: "HI-TECH POWER STEERING FLUID est un fluide premium pour directions assistées de voitures, véhicules utilitaires, SUV et 4x4. Il assure une direction souple et précise tout en protégeant le système.",
        },
        features: {
          en: ["Protects against wear and corrosion to extend system life.", "Enhances steering control for smoother, more precise handling.", "Excellent thermal stability and anti-oxidation performance.", "Foam control reduces noise and vibration for stable operation."],
          tr: ["Aşınma ve korozyona karşı koruyarak sistem ömrünü uzatır.", "Daha yumuşak ve hassas kullanım için direksiyon kontrolünü geliştirir.", "Mükemmel termal kararlılık ve oksidasyon koruması sunar.", "Köpük kontrolü gürültü ve titreşimi azaltır."],
          ru: ["Защищает от износа и коррозии, продлевая ресурс системы.", "Повышает точность и плавность рулевого управления.", "Обеспечивает термостабильность и защиту от окисления.", "Контроль пенообразования снижает шум и вибрацию."],
          fa: ["در برابر سایش و خوردگی محافظت کرده و عمر سامانه را افزایش می‌دهد.", "کنترل فرمان را برای هدایت روان و دقیق بهبود می‌دهد.", "پایداری حرارتی و حفاظت اکسیداسیون عالی.", "کنترل کف، صدا و لرزش را کاهش می‌دهد."],
          ar: ["يحمي من التآكل والصدأ ويطيل عمر النظام.", "يعزز التحكم بالتوجيه لقيادة أكثر سلاسة ودقة.", "ثبات حراري وحماية ممتازة من الأكسدة.", "التحكم بالرغوة يقلل الضوضاء والاهتزاز."],
          de: ["Schützt vor Verschleiß und Korrosion und verlängert die Systemlebensdauer.", "Verbessert die Lenkpräzision und Laufruhe.", "Bietet Temperaturstabilität und Oxidationsschutz.", "Schaumkontrolle reduziert Geräusche und Vibrationen."],
          fr: ["Protège contre l'usure et la corrosion et prolonge la vie du système.", "Améliore le contrôle pour une direction plus souple et précise.", "Excellente stabilité thermique et protection contre l'oxydation.", "Le contrôle de la mousse réduit bruit et vibrations."],
        },
        standards: "Suitable for passenger cars, commercial vehicles, SUVs and 4x4 power-steering systems",
        packaging: ["1 L", "200 L"],
      },
      "ATF-DSG": {
        description: {
          en: "HI-TECH ATF DSG is a fully synthetic dual-clutch transmission fluid for modern DSG systems. It is designed for smooth, precise shifting in Volkswagen Group, Mercedes-Benz 7-speed DSG, Mitsubishi TC-SST and compatible applications.",
          tr: "HI-TECH ATF DSG, modern DSG sistemleri için tam sentetik çift kavramalı şanzıman yağıdır. Volkswagen Grubu, Mercedes-Benz 7 ileri DSG, Mitsubishi TC-SST ve uyumlu uygulamalarda yumuşak ve hassas vites geçişi için geliştirilmiştir.",
          ru: "HI-TECH ATF DSG — полностью синтетическая жидкость для современных коробок с двойным сцеплением. Обеспечивает плавные переключения в системах Volkswagen Group, Mercedes-Benz 7-speed DSG, Mitsubishi TC-SST и совместимых применениях.",
          fa: "HI-TECH ATF DSG سیال تمام‌سنتتیک گیربکس دوکلاچه برای سامانه‌های مدرن DSG است و تعویض دنده روان و دقیق را در خودروهای سازگار فراهم می‌کند.",
          ar: "HI-TECH ATF DSG سائل اصطناعي بالكامل لنواقل الحركة مزدوجة القابض الحديثة، مصمم للتبديل السلس والدقيق في تطبيقات DSG المتوافقة.",
          de: "HI-TECH ATF DSG ist eine vollsynthetische Doppelkupplungsgetriebeflüssigkeit für moderne DSG-Systeme. Sie ermöglicht sanfte, präzise Schaltvorgänge in kompatiblen Anwendungen.",
          fr: "HI-TECH ATF DSG est un fluide entièrement synthétique pour transmissions modernes à double embrayage, conçu pour des passages de rapports souples et précis dans les applications compatibles.",
        },
        features: {
          en: ["Excellent clutch performance provides smooth and precise shifting.", "Optimal thermal stability protects at high temperatures.", "Superior wear protection extends transmission life.", "Designed for reliable, efficient operation in modern DSG systems."],
          tr: ["Mükemmel kavrama performansı yumuşak ve hassas vites geçişi sağlar.", "Optimum termal kararlılık yüksek sıcaklıklarda korur.", "Üstün aşınma koruması şanzıman ömrünü uzatır.", "Modern DSG sistemlerinde güvenilir ve verimli çalışma için tasarlanmıştır."],
          ru: ["Высокие фрикционные свойства обеспечивают точные переключения.", "Термостабильность защищает при высокой температуре.", "Защита от износа продлевает ресурс коробки.", "Разработано для надёжной работы современных DSG."],
          fa: ["عملکرد عالی کلاچ، تعویض دنده روان و دقیق را فراهم می‌کند.", "پایداری حرارتی در دمای بالا محافظت می‌کند.", "حفاظت برتر ضد سایش عمر گیربکس را افزایش می‌دهد.", "برای عملکرد مطمئن DSG طراحی شده است."],
          ar: ["أداء ممتاز للقابض لتبديل سلس ودقيق.", "ثبات حراري مثالي للحماية في الحرارة العالية.", "حماية فائقة من التآكل تطيل عمر ناقل الحركة.", "مصمم للتشغيل الموثوق والفعال في DSG."],
          de: ["Ausgezeichnete Kupplungsleistung ermöglicht präzises Schalten.", "Optimale Temperaturstabilität schützt bei Hitze.", "Verschleißschutz verlängert die Getriebelebensdauer.", "Für zuverlässigen DSG-Betrieb entwickelt."],
          fr: ["Excellentes performances d'embrayage pour des passages précis.", "Stabilité thermique optimale à haute température.", "Protection anti-usure prolongeant la transmission.", "Conçu pour un fonctionnement DSG fiable et efficace."],
        },
        standards: "VW G 052 182 / G 052 529, VW TL 521 82, Audi TL 521 82",
        packaging: ["1 L", "200 L"],
      },
      "ATF-Dexron-III": {
        description: {
          en: "HI-TECH ATF DEXRON III is a premium automatic transmission fluid for GM, Ford, Chrysler and other Dexron III applications. It supports smoother shifting and extended transmission life.",
          tr: "HI-TECH ATF DEXRON III; GM, Ford, Chrysler ve diğer Dexron III uygulamaları için premium otomatik şanzıman yağıdır. Daha yumuşak vites geçişi ve uzun şanzıman ömrü sağlar.",
          ru: "HI-TECH ATF DEXRON III — премиальная жидкость для АКПП GM, Ford, Chrysler и других применений Dexron III. Обеспечивает плавные переключения и долгий ресурс.",
          fa: "HI-TECH ATF DEXRON III سیال ممتاز گیربکس اتوماتیک برای GM، Ford، Chrysler و سایر کاربردهای Dexron III است.",
          ar: "HI-TECH ATF DEXRON III سائل ممتاز لناقل الحركة الأوتوماتيكي لتطبيقات GM وFord وChrysler وغيرها من Dexron III.",
          de: "HI-TECH ATF DEXRON III ist eine Premium-Automatikgetriebeflüssigkeit für GM, Ford, Chrysler und weitere Dexron-III-Anwendungen.",
          fr: "HI-TECH ATF DEXRON III est un fluide premium pour transmissions automatiques GM, Ford, Chrysler et autres applications Dexron III.",
        },
        features: {
          en: ["Excellent wear protection reduces wear and extends component life.", "Superior thermal stability performs at high and low temperatures.", "Oxidation control resists sludge and varnish buildup.", "Optimal friction performance enables smooth, precise shifting."],
          tr: ["Mükemmel aşınma koruması parça ömrünü uzatır.", "Üstün termal kararlılık yüksek ve düşük sıcaklıklarda çalışır.", "Oksidasyon kontrolü tortu ve vernik oluşumuna direnir.", "Optimum sürtünme performansı yumuşak ve hassas geçiş sağlar."],
          ru: ["Защита от износа продлевает ресурс деталей.", "Термостабильность при высоких и низких температурах.", "Контроль окисления препятствует шламу и лаку.", "Оптимальное трение обеспечивает точные переключения."],
          fa: ["حفاظت عالی ضد سایش عمر اجزا را افزایش می‌دهد.", "پایداری حرارتی در دمای بالا و پایین.", "کنترل اکسیداسیون در برابر لجن و لاک.", "اصطکاک بهینه برای تعویض دنده روان."],
          ar: ["حماية ممتازة من التآكل تطيل عمر المكونات.", "ثبات حراري في درجات الحرارة العالية والمنخفضة.", "مقاومة للأكسدة والحمأة.", "احتكاك مثالي لتبديل سلس ودقيق."],
          de: ["Verschleißschutz verlängert die Komponentenlebensdauer.", "Temperaturstabilität bei hohen und niedrigen Temperaturen.", "Oxidationskontrolle verhindert Schlamm und Lack.", "Optimale Reibung ermöglicht präzises Schalten."],
          fr: ["Protection anti-usure prolongeant les composants.", "Stabilité thermique à haute et basse température.", "Contrôle de l'oxydation contre boues et vernis.", "Friction optimale pour des passages souples."],
        },
        standards: "GM Dexron III compatible, Ford, Chrysler and other Dexron III applications",
        packaging: ["1 L", "200 L"],
      },
      "ATF-Dexron-VI": {
        description: {
          en: "HI-TECH ATF DEXRON VI is an automatic transmission fluid approved for GM Dexron VI applications and suitable for compatible GM, Ford and Chrysler vehicles. It provides smooth shifting, quiet operation and long transmission life.",
          tr: "HI-TECH ATF DEXRON VI, GM Dexron VI onaylı otomatik şanzıman yağıdır; uyumlu GM, Ford ve Chrysler araçlarında kullanıma uygundur. Yumuşak geçiş, sessiz çalışma ve uzun şanzıman ömrü sağlar.",
          ru: "HI-TECH ATF DEXRON VI — одобренная GM Dexron VI жидкость для совместимых АКПП GM, Ford и Chrysler. Обеспечивает плавные переключения, тихую работу и долгий ресурс.",
          fa: "HI-TECH ATF DEXRON VI سیال گیربکس اتوماتیک مورد تأیید GM Dexron VI برای خودروهای سازگار GM، Ford و Chrysler است.",
          ar: "HI-TECH ATF DEXRON VI سائل ناقل حركة أوتوماتيكي معتمد من GM Dexron VI للمركبات المتوافقة من GM وFord وChrysler.",
          de: "HI-TECH ATF DEXRON VI ist eine nach GM Dexron VI zugelassene Automatikgetriebeflüssigkeit für kompatible GM-, Ford- und Chrysler-Fahrzeuge.",
          fr: "HI-TECH ATF DEXRON VI est un fluide de transmission automatique homologué GM Dexron VI pour les véhicules GM, Ford et Chrysler compatibles.",
        },
        features: {
          en: ["GM Dexron VI approved performance.", "Excellent protection against wear and rust.", "Superior thermal stability and oxidation resistance.", "Smooth, quiet shifting extends transmission reliability."],
          tr: ["GM Dexron VI onaylı performans.", "Aşınma ve pasa karşı mükemmel koruma.", "Üstün termal kararlılık ve oksidasyon direnci.", "Yumuşak ve sessiz geçiş şanzıman güvenilirliğini artırır."],
          ru: ["Характеристики одобрены GM Dexron VI.", "Защита от износа и ржавчины.", "Термостабильность и стойкость к окислению.", "Плавные тихие переключения повышают надёжность."],
          fa: ["عملکرد تأییدشده GM Dexron VI.", "حفاظت عالی در برابر سایش و زنگ.", "پایداری حرارتی و اکسیداسیون برتر.", "تعویض دنده روان و کم‌صدا."],
          ar: ["أداء معتمد GM Dexron VI.", "حماية ممتازة من التآكل والصدأ.", "ثبات حراري ومقاومة للأكسدة.", "تبديل سلس وهادئ يطيل موثوقية الناقل."],
          de: ["Nach GM Dexron VI zugelassene Leistung.", "Schutz vor Verschleiß und Rost.", "Temperatur- und Oxidationsstabilität.", "Sanftes, leises Schalten erhöht die Zuverlässigkeit."],
          fr: ["Performances homologuées GM Dexron VI.", "Protection contre l'usure et la rouille.", "Stabilité thermique et résistance à l'oxydation.", "Passages souples et silencieux pour une fiabilité durable."],
        },
        standards: "GM Dexron VI approved; suitable for compatible GM, Ford, Chrysler and other Dexron VI applications",
        packaging: ["1 L", "200 L"],
      },
      "ATF-Dexron-II": {
        description: {
          en: "HI-TECH ATF DEXRON II is a fully synthetic automatic transmission fluid for GM, Ford, Chrysler and other Dexron II applications. It delivers smooth operation, advanced protection and efficient transmission performance.",
          tr: "HI-TECH ATF DEXRON II; GM, Ford, Chrysler ve diğer Dexron II uygulamaları için tam sentetik otomatik şanzıman yağıdır. Yumuşak çalışma, gelişmiş koruma ve verimli şanzıman performansı sağlar.",
          ru: "HI-TECH ATF DEXRON II — полностью синтетическая жидкость для АКПП GM, Ford, Chrysler и других применений Dexron II. Обеспечивает плавную работу и эффективную защиту.",
          fa: "HI-TECH ATF DEXRON II سیال تمام‌سنتتیک گیربکس اتوماتیک برای GM، Ford، Chrysler و سایر کاربردهای Dexron II است.",
          ar: "HI-TECH ATF DEXRON II سائل اصطناعي بالكامل لناقل الحركة الأوتوماتيكي لتطبيقات GM وFord وChrysler وغيرها من Dexron II.",
          de: "HI-TECH ATF DEXRON II ist eine vollsynthetische Automatikgetriebeflüssigkeit für GM, Ford, Chrysler und weitere Dexron-II-Anwendungen.",
          fr: "HI-TECH ATF DEXRON II est un fluide entièrement synthétique pour transmissions automatiques GM, Ford, Chrysler et autres applications Dexron II.",
        },
        features: {
          en: ["Excellent wear protection supports smooth, precise shifting.", "Optimal thermal stability protects at high temperatures.", "Superior rust and oxidation protection extends transmission life.", "Designed for reliable and efficient Dexron II system operation."],
          tr: ["Mükemmel aşınma koruması yumuşak ve hassas geçiş sağlar.", "Optimum termal kararlılık yüksek sıcaklıkta korur.", "Üstün pas ve oksidasyon koruması şanzıman ömrünü uzatır.", "Dexron II sistemlerinde güvenilir ve verimli çalışma için tasarlanmıştır."],
          ru: ["Защита от износа обеспечивает точные переключения.", "Термостабильность защищает при высокой температуре.", "Защита от ржавчины и окисления продлевает ресурс.", "Для надёжной работы систем Dexron II."],
          fa: ["حفاظت عالی ضد سایش برای تعویض دنده روان.", "پایداری حرارتی در دمای بالا.", "حفاظت زنگ و اکسیداسیون عمر گیربکس را افزایش می‌دهد.", "برای عملکرد مطمئن Dexron II."],
          ar: ["حماية ممتازة من التآكل لتبديل سلس.", "ثبات حراري للحماية في الحرارة العالية.", "حماية من الصدأ والأكسدة تطيل عمر الناقل.", "مصمم لتشغيل Dexron II الموثوق."],
          de: ["Verschleißschutz ermöglicht präzises Schalten.", "Temperaturstabilität schützt bei Hitze.", "Rost- und Oxidationsschutz verlängern die Lebensdauer.", "Für zuverlässige Dexron-II-Systeme entwickelt."],
          fr: ["Protection anti-usure pour des passages précis.", "Stabilité thermique à haute température.", "Protection antirouille et antioxydation prolongeant la transmission.", "Conçu pour les systèmes Dexron II."],
        },
        standards: "GM Dexron II, Ford Mercon, Chrysler ATF+2, Allison C-4 and other Dexron II specifications",
        packaging: ["1 L", "200 L"],
      },
      "ATF-CVT": {
        description: {
          en: "HI-TECH ATF CVT is a fully synthetic continuously variable transmission fluid for modern CVT vehicles. Its CVT-specific formula is designed for accurate shifting and long transmission life in compatible Nissan, Toyota, Honda, Subaru, Mitsubishi, Suzuki, Hyundai and Kia vehicles.",
          tr: "HI-TECH ATF CVT, modern CVT araçlar için tam sentetik sürekli değişken şanzıman yağıdır. CVT'ye özel formülü; uyumlu Nissan, Toyota, Honda, Subaru, Mitsubishi, Suzuki, Hyundai ve Kia araçlarında hassas geçiş ve uzun şanzıman ömrü sağlar.",
          ru: "HI-TECH ATF CVT — полностью синтетическая жидкость для современных вариаторов. Специальная формула обеспечивает точную работу и долгий ресурс в совместимых автомобилях.",
          fa: "HI-TECH ATF CVT سیال تمام‌سنتتیک برای گیربکس‌های متغیر پیوسته مدرن است و عملکرد دقیق و عمر طولانی گیربکس را فراهم می‌کند.",
          ar: "HI-TECH ATF CVT سائل اصطناعي بالكامل لنواقل الحركة المتغيرة باستمرار الحديثة، مصمم للدقة والعمر الطويل في المركبات المتوافقة.",
          de: "HI-TECH ATF CVT ist eine vollsynthetische Flüssigkeit für moderne stufenlose Getriebe. Die CVT-spezifische Formel ermöglicht präzisen Betrieb und lange Getriebelebensdauer.",
          fr: "HI-TECH ATF CVT est un fluide entièrement synthétique pour transmissions à variation continue modernes. Sa formule spécifique assure précision et longue durée de transmission.",
        },
        features: {
          en: ["Excellent wear protection safeguards CVT components.", "Optimal temperature stability across operating conditions.", "Smooth and quiet transmission performance.", "CVT-specific formula extends transmission life."],
          tr: ["Mükemmel aşınma koruması CVT bileşenlerini korur.", "Tüm çalışma koşullarında optimum sıcaklık kararlılığı.", "Yumuşak ve sessiz şanzıman performansı.", "CVT'ye özel formül şanzıman ömrünü uzatır."],
          ru: ["Защита от износа сохраняет компоненты CVT.", "Температурная стабильность во всех режимах.", "Плавная и тихая работа.", "Специальная формула продлевает ресурс вариатора."],
          fa: ["حفاظت عالی ضد سایش از اجزای CVT.", "پایداری دمایی بهینه.", "عملکرد روان و کم‌صدا.", "فرمول ویژه CVT عمر گیربکس را افزایش می‌دهد."],
          ar: ["حماية ممتازة من التآكل لمكونات CVT.", "ثبات مثالي لدرجة الحرارة.", "أداء سلس وهادئ.", "صيغة خاصة تطيل عمر ناقل CVT."],
          de: ["Verschleißschutz für CVT-Komponenten.", "Optimale Temperaturstabilität.", "Sanfte und leise Getriebeleistung.", "CVT-spezifische Formel verlängert die Lebensdauer."],
          fr: ["Protection anti-usure des composants CVT.", "Stabilité optimale de température.", "Fonctionnement souple et silencieux.", "Formule CVT prolongeant la transmission."],
        },
        standards: "CVT compatible: Nissan, Toyota, Honda, Subaru, Mitsubishi, Suzuki, Hyundai, Kia and other compatible applications",
        packaging: ["1 L", "200 L"],
      },
    },
  },
