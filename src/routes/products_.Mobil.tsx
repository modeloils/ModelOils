...
export const Route = createFileRoute("/products_/Mobil")({
  component: MobilPage,
});
  ...
  return (
    <BrandCatalogPage
      ...
      catalogs={[
        ...
        { title: "Marine Oils", href: "/model-oils/docs/mobil/mobil-marine-lubricants-chart.pdf" },
        { title: "Racing Oils", href: "/model-oils/docs/mobil/mobil-1-racing-official.pdf" },
        { title: "Industrial Oils", href: "/model-oils/docs/mobil/mobil-industrial-lubricants.pdf" },
      ]}
    />
  );
}
